...
public class CallLogActivity extends Activity implements CallLogQueryHandler.Listener,
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public int getCount() {
            ...
            count = ExtensionManager.getInstance().getCallLogExtension().getTabCount(CallLogActivity.this, count);
            return count;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /// M: for Plug-in init the reject mode flag @{
        ExtensionManager.getInstance().getCallLogExtension().initRejectMode(this);
        /// @}
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        /// M: for plug-in
        ExtensionManager.getInstance().getCallLogExtension().prepareCallLogMenu(this,menu);
    ...
    public void onBackPressed() {
        /// M: for Plug-in @{
        ExtensionManager.getInstance().getCallLogExtension().onBackPressed(this, mViewPagerAdapter, this);
        /// @}
    }
    ...
    public void onDestroy() {
        ...
        /// M: for Plug-in manage the hashmap @{
        ExtensionManager.getInstance().getCallLogExtension().clearObjects(this);
        /// @}
        super.onDestroy();
    }
}
