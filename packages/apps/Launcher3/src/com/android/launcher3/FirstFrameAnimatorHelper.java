...
public class FirstFrameAnimatorHelper extends AnimatorListenerAdapter
    ...
    /// M. ALPS02153511, add for set amimator druation
    /// scale as 0 in development. {@
    ...
    public void onAnimationUpdate(final ValueAnimator animation) {
        ...
        /// M. ALPS02153511, add for set amimator druation
        /// scale as 0 in development. {@
        float animitionScale = 0;
        try {
            IWindowManager wm = IWindowManager.Stub.asInterface(
                    ServiceManager.getService("window"));
            animitionScale = wm.getAnimationScale(ANIMATOR_DURATION_SCALE);
        } catch (RemoteException e) {
            Log.e("FirstFrameAnimatorHelper", "RemoteException");
        }
        if (DEBUG) {
            Log.d("FirstFrameAnimatorHelper", "[guo]isPowerSaveMode: " + isPowerSaveMode
                + "animitionScale:" + animitionScale);
        }
        /// M. @}
        ...
        if (!mHandlingOnAnimationUpdate &&
            ...
            /// M. ALPS02153511, add for set amimator druation
            /// scale as 0 in development. {@
            !isPowerSaveMode && (animitionScale != 0)) {
            /// M. @}
