...
////////////////////////////Public funtion///////////////////////////////////////////////////////
    ...
    public void handleProcessor(Context context, int subId, int workType, Intent intent) {
        LogUtils.d(TAG, "[handleProcessor] subId=" + subId + ",time=" + System.currentTimeMillis());
        SIMProcessorBase processor = createProcessor(context, subId, workType, intent);
        if (processor != null && mListener != null) {
            LogUtils.d(TAG, "[handleProcessor]Add processor [subId=" +
                    subId + "] to threadPool.");
...
////////////////////////////private funtion///////////////////////////////////////////////////////
    ...
    private SIMProcessorBase createProcessor(Context context, int subId, int workType, Intent intent) {
        ...
        synchronized (mProcessorRemoveLock) {
            ...
            if (mImportRemoveProcessors.containsKey(subId)) {
                ...
                LogUtils.d(TAG, "[createProcessor]no processor for subId: " + subId);
            }
    ...
    private SIMProcessorBase createProcessor(Context context, int subId, int workType, Intent intent, ProcessorCompleteListener listener) {
        Log.v(TAG, "[createProcessor] create new processor for subId: " + subId + ", workType: " + workType);
        SIMProcessorBase processor = null;
    ...
    private ProcessorCompleteListener mProcessoListener = new ProcessorCompleteListener() {
        ...
        public void onProcessorCompleted(Intent intent) {
            if (intent != null) {
                ...
                LogUtils.d(TAG, "[onProcessorCompleted] subId = " + subId + " time=" + System.currentTimeMillis() + ", workType = " + workType);
                /**
                 * [ALPS01224227]the mImportRemoveProcessors is likely to be accessed by main thread and sub thread
                 * at the same time, we should protect the race condition
                 */
                synchronized (mProcessorRemoveLock) {
                    if ((workType == SIMServiceUtils.SERVICE_WORK_IMPORT
                        ...
                        LogUtils.d(TAG, "[onProcessorCompleted] remove import/remove processor subId=" + subId);
                        /**
