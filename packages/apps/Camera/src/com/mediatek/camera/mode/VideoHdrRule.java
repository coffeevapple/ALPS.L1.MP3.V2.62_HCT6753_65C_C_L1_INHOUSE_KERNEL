    ...
    public class VideoHdrRule implements ISettingRule {
        ...
        public void execute() {
            ...
            if (index == -1) {
                ...
                if (mICameraContext.getFeatureConfig().isZSDHDRSupported()) {
                    int cameraId = mICameraDeviceManager.getCurrentCameraId();
                    ParametersHelper.setParametersValue(mParameters, cameraId, SettingConstants.KEY_HDR, "off");
                }
            } else {
        ...
        private void setHdrRule() {
            ...
            if (ParametersHelper.getParametersSupportedValues(mParameters, SettingConstants.KEY_HDR) == null
                ...
                int cameraId = mICameraDeviceManager.getCurrentCameraId();
                SettingItem setting = mISettingCtrl.getSetting(SettingConstants.KEY_HDR);
                ParametersHelper.setParametersValue(mParameters, cameraId, SettingConstants.KEY_HDR, setting.getValue());
            } 
        }
