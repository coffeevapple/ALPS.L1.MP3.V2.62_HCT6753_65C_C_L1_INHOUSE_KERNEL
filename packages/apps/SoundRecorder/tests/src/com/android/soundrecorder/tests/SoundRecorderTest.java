...
public class SoundRecorderTest extends ActivityInstrumentationTestCase2<SoundRecorder> {
    ...
    public void testCase01_RecordAndStop() {
        ...
        assertTrue(SoundRecorderTestUtils.getCurrentState(mSoundRecorder) == SoundRecorderService.STATE_RECORDING);
        checkRecordingUI();
        ...
        assertTrue(SoundRecorderTestUtils.getCurrentState(mSoundRecorder) == SoundRecorderService.STATE_IDLE);
        checkSavingUI();
    ...
    public void testCase03_PlayAndPauseAndGoonAndStop() {
        ...
        mSolo.sleep(WAIT_FOR_RESPOND_TIME);
        assertTrue(SoundRecorderTestUtils.getCurrentState(mSoundRecorder) == SoundRecorderService.STATE_PLAYING);
        checkPlayingUI();

        // pause play
        mSolo.clickOnView(mPlayButton);
        mSolo.sleep(WAIT_FOR_RESPOND_TIME);
        assertTrue(SoundRecorderTestUtils.getCurrentState(mSoundRecorder) == SoundRecorderService.STATE_PAUSE_PLAYING);
        checkPlayingUI();
