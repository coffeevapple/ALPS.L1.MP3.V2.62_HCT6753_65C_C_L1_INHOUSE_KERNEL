...
public class SoundRecorderStressTest extends
    ...
    private enum STATE {
        INIT, RECORD, PAUSE_RECORD, STOP_RECORD_TO_SAVE, STOP_RECORD_PLAY, STOP_RECORD_PAUSE_PLAY, STOP_RECORD_STOP_PLAY, PLAY, PAUSE_PALY, STOP_PLAY, NORAML, EDIT, DELETE
    }
