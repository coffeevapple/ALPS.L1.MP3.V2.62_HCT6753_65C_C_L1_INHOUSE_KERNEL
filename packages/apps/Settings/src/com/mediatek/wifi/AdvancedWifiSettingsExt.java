...
public class AdvancedWifiSettingsExt {
   ...
   private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
    ...
    private void addWifiInfoPreference() {
        ...
        //add ipv6 preference
        if (FeatureOption.MTK_DHCPV6C_WIFI) {
            if (screen.findPreference(KEY_CURRENT_IPV6_ADDRESS) == null) {
                mIpAddressPref.setTitle(R.string.wifi_advanced_ipv4_address_title);
                mIpv6AddressPref = new Preference(mActivity, null, android.R.attr.preferenceInformationStyle);
            ...
            mIpv6AddressPref.setOrder(order);
        }
    }
