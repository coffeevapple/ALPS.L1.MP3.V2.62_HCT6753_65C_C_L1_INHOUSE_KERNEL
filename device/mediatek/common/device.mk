...
ifeq ($(strip $(MTK_EPDG_SUPPORT)), yes)
  ...
  PRODUCT_PROPERTY_OVERRIDES += persist.net.wo.ocsp=0
  PRODUCT_PROPERTY_OVERRIDES += persist.net.wo.urlcert=0
  PRODUCT_PROPERTY_OVERRIDES += persist.net.wo.nocert=1
  PRODUCT_PROPERTY_OVERRIDES += persist.net.wo.noid=1
  PRODUCT_PROPERTY_OVERRIDES += persist.net.wo.ssepdg=1
