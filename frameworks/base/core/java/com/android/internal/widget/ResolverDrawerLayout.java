...
public class ResolverDrawerLayout extends ViewGroup {
     ...
     */
    /// M: [ALPS02166240]Fix floating point precision issue
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (Math.abs(dy) > mTouchSlop && findChildUnder(x, y) != null &&
                    ...
                    mIsDragging = true;
                    mLastTouchY = (int) Math.max(mLastTouchY - mTouchSlop,
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    ...
                    mInitialTouchY = mLastTouchY = (int) ev.getY();
                }
            ...
            case MotionEvent.ACTION_POINTER_DOWN: {
                ...
                mInitialTouchX = (int) ev.getX(pointerIndex);
                mInitialTouchY = mLastTouchY = (int) ev.getY(pointerIndex);
            }
            break;
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (!wasDragging && findChildUnder(mInitialTouchX, mInitialTouchY) == null &&
                        findChildUnder((int) ev.getX(), (int) ev.getY()) == null) {
                ...
                if (mOpenOnClick && Math.abs((int) ev.getX() - mInitialTouchX) < mTouchSlop &&
                        Math.abs((int) ev.getY() - mInitialTouchY) < mTouchSlop) {
                    smoothScrollTo(0, 0);
                    return true;
                }
    ...
    private void onSecondaryPointerUp(MotionEvent ev) {
        ...
        if (pointerId == mActivePointerId) {
            ...
            mInitialTouchX = (int) ev.getX(newPointerIndex);
            mInitialTouchY = mLastTouchY = (int) ev.getY(newPointerIndex);
    ...
    private float performDrag(float dy) {
        final int newPos = (int) Math.max(0, Math.min(mCollapseOffset + dy,
