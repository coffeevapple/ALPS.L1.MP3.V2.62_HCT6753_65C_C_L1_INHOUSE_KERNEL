...
public class MtkPhoneWindowManager extends PhoneWindowManager {
    ...
    public void layoutWindowLw(WindowState win, WindowState attached) {
        ...
        if (!win.isFloatingWindow() || !mIsDefaultDisplay) {
            ...
            if ((getInputMethodWindowVisibleHeightLw() > 0 && mCurrentInputMethodTargetWindow == win)
                 || (mCurrentInputMethodTargetWindow != null && mCurrentInputMethodTargetWindow != win
                        && mFocusedApp == win.getAppToken() && mCurrentInputMethodTargetWindow.isFocusStack()
                        && mCurrentInputMethodTargetWindow.isVisibleLw()
                        && mCurrentInputMethodWindow != null
                        && win.getSurfaceLayer() > mCurrentInputMethodWindow.getSurfaceLayer())) {
