...
public class SvlteModeController extends Handler {
    ...
    */
    ...
    private void configModemStatus() {
        ...
        while (true) {
            if (CdmaFeatureOptionUtils.isC2KWorldPhoneP2Support()) {
                logicLog("configModemStatus: Solution2");
                // case1: slot1 CDMA
                ...
                logicLog("configModemStatus: Solution1/OP09");
                boolean md3AccessProtocol2 = false;
                if ((is4GCdmaCard(cardType2) || is3GCdmaCard(cardType2))//slot2:CDMA
                        && capability != 1) {// ES3G=2
                    logicLog("configModemStatus md3AccessProtocol2 = true!");
