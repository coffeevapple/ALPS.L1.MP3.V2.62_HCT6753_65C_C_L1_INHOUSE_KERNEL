...
public class ImsPhone extends ImsPhoneBase {
    ...
    public boolean isFeatureSupported(FeatureType feature) {
        ...
        if (feature == FeatureType.VOLTE_ENHANCED_CONFERENCE) {
            ...
            featureSupportedMccMncList = new ArrayList<String>();

            // 1. OP18: 405840, 405854 ~ 405874
            for (int i = 854; i <= 874; i++) {
                featureSupportedMccMncList.add("405" + i);
            }
            featureSupportedMccMncList.add("405840");
            featureName = "VOLTE_CONF_REMOVE_MEMBER";
        }
