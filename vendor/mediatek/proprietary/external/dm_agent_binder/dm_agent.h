...
enum {
    ...
    TRANSACTION_getMacAddr,
    TRANSACTION_writeIccID1,
    TRANSACTION_writeIccID2,
    TRANSACTION_readIccID1,
    TRANSACTION_readIccID2,
    TRANSACTION_setSelfRegisterFlag,
    TRANSACTION_readSelfRegisterFlag,
};
...
public:
    ...
    virtual bool writeIccID1(char * iccID, int size)=0;
    virtual bool writeIccID2(char * iccID, int size)=0;
    virtual char * readIccID1(int & size)=0;
    virtual char * readIccID2(int & size)=0;
    virtual char * getMacAddr(int & size)=0;
    virtual bool setSelfRegisterFlag(char * flag, int size)=0;
    virtual char * readSelfRegisterFlag(int & size)=0;
};
...
public:
    ...
    bool writeIccID1(char * iccID, int size) {return 0;}
    bool writeIccID2(char * iccID, int size) {return 0;}
    char * readIccID1(int & size) {return 0;}
    char * readIccID2(int & size) {return 0;}
    char * getMacAddr(int & size) {return 0;}
    bool setSelfRegisterFlag(char * flag,int size) {return 1;}
    char * readSelfRegisterFlag(int & size) {return 0;}
};
...
public:
    ...
    virtual bool writeIccID1(char * iccID, int size);
    virtual bool writeIccID2(char * iccID, int size);
    virtual char * readIccID1(int & size);
    virtual char * readIccID2(int & size);
    virtual char * getMacAddr(int & size);
    virtual bool setSelfRegisterFlag(char * flag, int size);
    virtual char * readSelfRegisterFlag(int & size);
};
