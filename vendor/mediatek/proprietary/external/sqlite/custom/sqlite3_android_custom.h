...
/**
* STATIC VARIABLE
*    NAME_MATCH_DEFAUL_TYPE
*
* DESCRIPTION
*   A flag indicates which default name matching function is used when get_name_match_function() return 0.
*                       The valid values are 0,1,2.
*                       If 0, a name matching function
*                       If 1, A new name matching function 
*                       If 2, An accurate name matching function
*/
static int NAME_MATCH_DEFAUL_TYPE = 0;

/**
* STATIC VARIABLE
*    NUMBER_MATCH_DEFAUL_TYPE
*
* DESCRIPTION
*   A flag indicates which default number matching function is used when get_number_match_function() return 0.
...
*/
static int NUMBER_MATCH_DEFAUL_TYPE = 1;
