...
#if 0
#define LOGV(...) printf(__VA_ARGS__)//__android_log_print(ANDROID_LOG_VERBOSE, "AUTOKD", __VA_ARGS__) 
#define LOGD(...) printf(__VA_ARGS__)//__android_log_print(ANDROID_LOG_DEBUG  , "AUTOKD", __VA_ARGS__) 
#define LOGI(...) printf(__VA_ARGS__)//__android_log_print(ANDROID_LOG_INFO   , "AUTOKD", __VA_ARGS__) 
#define LOGW(...) printf(__VA_ARGS__)//__android_log_print(ANDROID_LOG_WARN   , "AUTOKD", __VA_ARGS__) 
#define LOGE(...) printf(__VA_ARGS__)//__android_log_print(ANDROID_LOG_ERROR  , "AUTOKD", __VA_ARGS__) 
#else
#define LOGV(...) __android_log_print(ANDROID_LOG_VERBOSE, "AUTOKD", __VA_ARGS__) 
#define LOGD(...) __android_log_print(ANDROID_LOG_DEBUG  , "AUTOKD", __VA_ARGS__) 
#define LOGI(...) __android_log_print(ANDROID_LOG_INFO   , "AUTOKD", __VA_ARGS__) 
#define LOGW(...) __android_log_print(ANDROID_LOG_WARN   , "AUTOKD", __VA_ARGS__) 
#define LOGE(...) __android_log_print(ANDROID_LOG_ERROR  , "AUTOKD", __VA_ARGS__) 
             
#endif             
#define PARAM_COUNT_DEVNODE "/sys/autok/param_count"
#define SS_DEVNODE "/sys/autok/ss_corner"
...
#define SUGGEST_VOL_DEVNODE "/sys/autok/suggest_vol"
...
#define LOG_DEVNODE "/sys/kernel/debug/autok_log"
#define BUF_LEN     1024
#define AUTOK_FREE(ptr) do{ free(ptr); ptr = NULL; } while(0)
extern unsigned int *g_autok_vcore;
extern int g_vcore_no;
