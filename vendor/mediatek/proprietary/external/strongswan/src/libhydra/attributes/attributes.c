...
ENUM_BEGIN(configuration_attribute_type_names, INTERNAL_IP4_ADDRESS, HOME_AGENT_ADDRESS,
	...
	"INTERNAL_IP6_PREFIX",
	"HOME_AGENT_ADDRESS");
ENUM_NEXT(configuration_attribute_type_names, CUST_PCSCF_IP4, CUST_PCSCF_IP6, HOME_AGENT_ADDRESS,
	"CUST_PCSCF_IP4",
	"CUST_TYPE_16385",
	"CUST_PCSCF_IP6");
ENUM_NEXT(configuration_attribute_type_names, XAUTH_TYPE, XAUTH_ANSWER, CUST_PCSCF_IP6,
	"XAUTH_TYPE",
	"XAUTH_USER_NAME",
	"XAUTH_USER_PASSWORD",
	"XAUTH_PASSCODE",
...
ENUM_BEGIN(configuration_attribute_type_short_names, INTERNAL_IP4_ADDRESS, HOME_AGENT_ADDRESS,
	...
	"PFX6",
	"HOA");
ENUM_NEXT(configuration_attribute_type_short_names, CUST_PCSCF_IP4, CUST_PCSCF_IP6, HOME_AGENT_ADDRESS,
	"PCSCF",
	"C_16385",
	"PCSCF6");
ENUM_NEXT(configuration_attribute_type_short_names, XAUTH_TYPE, XAUTH_ANSWER, CUST_PCSCF_IP6,
	"X_TYPE",
	"X_USER",
	"X_PWD",
	"X_CODE",
