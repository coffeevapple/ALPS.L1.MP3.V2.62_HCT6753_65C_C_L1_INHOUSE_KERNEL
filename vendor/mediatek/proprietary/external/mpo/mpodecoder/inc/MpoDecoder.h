...
public:
    ...
    SkBitmap* getImageBitmap(JNIEnv* env, int frameIndex, jobject options,SkBitmap::Allocator* javaalloctor=NULL);
private:
    ...
    SkBitmap* decodeBuffer(JNIEnv* env, jobject options, SkStreamRewindable* stream,SkBitmap::Allocator* javaalloctor=NULL);
protected:
    char *mPathname;
