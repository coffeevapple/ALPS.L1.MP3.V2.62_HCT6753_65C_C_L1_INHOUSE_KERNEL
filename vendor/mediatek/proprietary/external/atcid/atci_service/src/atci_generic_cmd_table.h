...
#endif
//#if defined(ENABLE_BLUETOOTH_AT_CMD)
...
static generic_cmd_type generic_cmd_table[] = {
        ...
        {"AT%FMR", AT_ACTION_OP | AT_READ_OP | AT_TEST_OP | AT_SET_OP, audio_fm_radio_control_handler},
#if defined(ENABLE_GPS_AT_CMD)
...
//changed end
        ...
        {"AT%BTTM", AT_ACTION_OP | AT_READ_OP | AT_TEST_OP | AT_SET_OP, bt_bttm_cmd_handler},
#endif
...
static mmi_cmd_type mmi_cmd_table[] = {
        ...
        {"AT%SUPPLEMENTARYSERVICE", AT_SET_OP},
        {"AT%ENABLEDATA", AT_SET_OP},
        {"AT%DATAON", AT_ACTION_OP},
        {"AT%DIAL", AT_SET_OP},
    };
