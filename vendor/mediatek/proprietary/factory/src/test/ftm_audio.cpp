...
static char * FileStartString_Receiver_FreqResponse[5] = {"//AudioReceiverFreq2K", "//AudioReceiverFreq25K", "//AudioReceiverFreq3K", "//AudioReceiverFreq35K", "//AudioReceiverFreq4K"};
static char * FileStartString_Speaker_FreqResponse[5] = {"//AudioSpeakerFreq05K", "//AudioSpeakerFreq075K", "//AudioSpeakerFreq1K", "//AudioSpeakerFreq15K", "//AudioSpeakerFreq2K"};
...
float CalculateTHD(unsigned int sampleRate, short *pData, kal_uint32 signalFrequency, float frequencyMargin)
{
    ...
    if (baseSignalLoc != 0)
    {
        unsigned int multiBaseSignalLoc, multiBaseSignalMag;
        k = 1;
