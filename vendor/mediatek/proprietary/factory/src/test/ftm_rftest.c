...
static void *lte_rf_update_thread(void *priv)
{
    ...
    // [ALPS02028385]-start
    char bandSetting1[BUF_SIZE];
    char bandSetting33[BUF_SIZE];
    // [ALPS02028385]-end
    ...
    if(!rf->test_done) {
        ...
        while(1){
            ...
            char *p_epbse = NULL;
            char *p_str = NULL;
            char *p_lte_band_1_32 = NULL;
            char *p_lte_band_33_64 = NULL;
            char *p_ok = NULL;

            memset(cmd_buf, 0, sizeof(cmd_buf));
            memset(rsp_buf, 0, sizeof(rsp_buf));
            memset(bandSetting1, 0, sizeof(bandSetting1));
            memset(bandSetting33, 0, sizeof(bandSetting33));
            ...
            if(p_epbse!= NULL){
                p_str = strstr(p_epbse, tok_split) + 1;
                p_lte_band_1_32 = strstr(p_str, tok_split) + 1;
                LOGD(TAG "p_lte_band_1_32=%s\n", p_lte_band_1_32);
                p_lte_band_33_64 = strstr(p_lte_band_1_32, tok_split) + 1;
                LOGD(TAG "p_lte_band_33_64=%s\n", p_lte_band_33_64);
                strncpy(bandSetting1, p_lte_band_1_32, p_lte_band_33_64-p_lte_band_1_32-1);
                strcpy(bandSetting33, p_lte_band_33_64);
                LOGD(TAG "bandSetting1=%s, bandSetting33=%s\n", bandSetting1, bandSetting33);
