...
static    android_audio_legacy::AudioMTKHardwareInterface *gAudioHardware = NULL;
static    android_audio_legacy::AudioMTKStreamOutInterface *gAudioStreamOut = NULL;
...
int Common_Audio_init(void)
{
    ...
    {
        gAudioHardware = android_audio_legacy::createMTKAudioHardware();
    }
    // get ftm module
...
static    android_audio_legacy::AudioMTKStreamOutInterface *vibspkStreamOutput = NULL;
...
void Audio_VSCurrent_Enable(bool enable)
{
    ...
    if (enable)
    {
        ...
        ********************************************/
        ...
        channels = android_audio_legacy::AudioSystem::CHANNEL_OUT_STEREO;
        format = android_audio_legacy::AudioSystem::PCM_16_BIT;
        vibspkStreamOutput = (android_audio_legacy::AudioMTKStreamOutInterface *)gAudioHardware->openOutputStream(0, &format, &channels, &sampleRate, &status);
