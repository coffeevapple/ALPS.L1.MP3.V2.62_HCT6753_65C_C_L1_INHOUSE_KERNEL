...
LOCAL_STATIC_LIBRARIES += libminiui libpixelflinger_static libpng libz libcutils libselinux
#LOCAL_STATIC_LIBRARIES += libstdc++ libc
LOCAL_STATIC_LIBRARIES += libfft

LOCAL_MODULE_CLASS := EXECUTABLES
factory_intermediates := $(call local-intermediates-dir)
DRVGEN_OUT := $(factory_intermediates)
include $(LOCAL_PATH)/drvgen.mk
LOCAL_GENERATED_SOURCES := $(DRVGEN_FILE_LIST)

LOCAL_C_INCLUDES += $(factory_intermediates)/inc
