...
# trumedia (from v3.1.x.x license token is used to distinguish trumedia hd or trumedia)
SRS_PRODUCT := trumedia_hd
...
SRS_USERCFG_PATH := /data/system/srs_processing.cfg
...
# AEQ FIR coeff file path
SRS_AEQ_FIR_COEFF_FILE_PATH := /data/system/aeq_fir_coeff.txt
