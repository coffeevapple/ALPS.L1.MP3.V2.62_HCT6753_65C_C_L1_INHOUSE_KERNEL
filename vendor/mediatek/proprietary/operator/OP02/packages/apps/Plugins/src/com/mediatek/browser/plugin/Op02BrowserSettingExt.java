...
public class Op02BrowserSettingExt extends DefaultBrowserSettingExt {
    ...
    public String getOperatorUA(String defaultUA) {
        ...
        String op02UA = model + " Linux/3.10.65 Android/" + Build.VERSION.RELEASE
                + " Release/" + strTime + " Browser/AppleWebKit537.36"
                + " Profile/MIDP-2.0 Configuration/CLDC-1.1"
                + " Chrome/39.0.0.0 Mobile Safari/537.36 System/Android "
                + Build.VERSION.RELEASE + "; Mozilla/5.0";
        return op02UA;
    }
}