...
# demo: if plug-in app need to accee to host app, please specify the host name as following example:
#LOCAL_APK_LIBRARIES += FileManager
LOCAL_APK_LIBRARIES += Calendar
