...
public class StreamingHooker extends PluginBaseHooker {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        mMenuDetail = menu.add(MENU_HOOKER_GROUP_ID, getMenuActivityId(MENU_DETAIL), 0, mPluginContext.getString(R.string.media_detail));
        mMenuInput = menu.add(MENU_HOOKER_GROUP_ID, getMenuActivityId(MENU_INPUT_URL), 0, mPluginContext.getString(R.string.input_url));
        mMenuSettings = menu.add(MENU_HOOKER_GROUP_ID, getMenuActivityId(MENU_SETTINGS), 0, mPluginContext.getString(R.string.streaming_settings));
        return true;
    }
    @Override
