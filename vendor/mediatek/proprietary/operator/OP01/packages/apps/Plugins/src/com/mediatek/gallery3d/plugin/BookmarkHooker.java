...
public class BookmarkHooker extends PluginBaseHooker {
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        mMenuBookmarkAdd = menu.add(MENU_HOOKER_GROUP_ID, getMenuActivityId(MENU_BOOKMARK_ADD), 0, mPluginContext.getString(R.string.bookmark_add));
        mMenuBookmarks = menu.add(MENU_HOOKER_GROUP_ID, getMenuActivityId(MENU_BOOKMARK_DISPLAY), 0, mPluginContext.getString(R.string.bookmark_display));
        return true;
    }
    @Override
