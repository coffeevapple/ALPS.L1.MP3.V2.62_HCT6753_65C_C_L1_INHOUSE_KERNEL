...
@PluginImpl(interfaceName="com.mediatek.mms.ext.IMmsPreferenceExt")
public class Op01MmsPreferenceExt extends DefaultMmsPreferenceExt {
    ...
    // private static final boolean MTK_GEMINI_SUPPORT = EncapsulationConstant.USE_MTK_PLATFORM ? SystemProperties.get("ro.mtk_gemini_support").equals("1")
    //        : false;
...
*/
        ...
        if (MTK_GEMINI_SUPPORT) {
            ...
            if (simList != null) {
                ...
                for (int index = 0; index < simCount; index ++) {
                    ...
                    String key = getSmsValidityKeyBySubId(slotId);
                    editor.remove(key);
                }
            }
            */
        	List<SubscriptionInfo> simList = SubscriptionManager.from(hostActivity).getActiveSubscriptionInfoList();
            if (simList != null) {
                int simCount = simList.size();
                for (int index = 0; index < simCount; index ++) {
            ...
            */
            ...
            if (simList != null) {
                ...
                for (int index = 0; index < simCount; index ++) {
                    ...
                    editor.putBoolean(Integer.toString(simId) + "_" + MMS_ENABLE_TO_SEND_DELIVERY_REPORT_KEY, false);
                }
            }
        } else {
    ...
    public Bundle getSmsValidityParamBundleWhenSend(Context context, int subId) {
        Xlog.d(TAG, "getSmsValidityParamBundleWhenSend, subId = " + subId);
        /* if (!EncapsulationConstant.USE_MTK_PLATFORM) {
            // if not mtk platform, no this feature
            return null;
        } */
...
//            extra.putInt(SmsManager.EXTRA_PARAMS_VALIDITY_PERIOD, valid);
    ...
    private void addSmsValidityPeriodPreference(final Activity hostActivity, PreferenceCategory pC, int simCount) {
        ...
        if (MTK_GEMINI_SUPPORT) {
            ...
            */
            final List<SubscriptionInfo> simList = SubscriptionManager.from(hostActivity).getActiveSubscriptionInfoList();
            ...
            if (simCount > 1) {
                p.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        ...
                        intent.setClassName(hostActivity, "com.android.mms.ui.SubSelectActivity");
    ...
    public void configSelectCardPreferenceTitle(Activity hostActivity) {
        ...
        } else if (preferenceName != null && preferenceName.equals(MMS_ENABLE_TO_SEND_DELIVERY_REPORT_KEY)) {
...
*/
        ...
        Xlog.d(TAG, "getSmsValiditybysubId: result index = " + index + ", validity =" + validities[index]);
...
//            }
            ...
            if (simCount > 1) {
                ...
                /* temp close for build , as com.mediatek.telephone can not ready
                    ...
                    */
                    ...
                    cp.setKey(Integer.toString(simId) + "_" + MMS_ENABLE_TO_SEND_DELIVERY_REPORT_KEY);
    ...
    public boolean configMmsPreferenceState(Activity hostActivity, String preference, int subId, CheckBoxPreference cp) {
        ...
        Xlog.d(TAG, "configMmsPreferenceState[simId]" + subId);
        ...
        if (preference != null && preference.equals(MMS_ENABLE_TO_SEND_DELIVERY_REPORT_KEY)) {
            boolean checked = prefs.getBoolean(Integer.toString(subId) + "_" + MMS_ENABLE_TO_SEND_DELIVERY_REPORT_KEY, false);
    ...
    public boolean setMmsPreferenceState(Activity hostActivity, String preference, int subId, boolean checked) {
        ...
        Xlog.d(TAG, "setMmsPreferenceState[simId]" + subId);
        ...
        if (preference.equals(MMS_ENABLE_TO_SEND_DELIVERY_REPORT_KEY)) {
            editor.putBoolean(Integer.toString(subId) + "_" + MMS_ENABLE_TO_SEND_DELIVERY_REPORT_KEY, checked);
            return true;
        }
        return false;
    }
    ...
    private boolean isEnableSendDeliveryReport(Context mContext, int subId) {
    ...
    public void setAcknowledgeDeliveryReport(Context mContext, int subId, AcknowledgeInd acknowledgeInd) {
        ...
        boolean reportAllowed = isEnableSendDeliveryReport(mContext, subId);
