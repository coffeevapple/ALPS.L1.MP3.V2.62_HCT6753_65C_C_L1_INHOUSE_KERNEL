...
public class Op01SmsReceiverExtTest extends InstrumentationTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        mPlugin =
        	(Op01SmsReceiverExt)MPlugin.createInstance("com.mediatek.mms.ext.ISmsReceiverExt",mContext);
    ...
    private SmsMessage[] genNormalSMS() {
        ...
        msgs[0] = SmsMessage.createFromPdu(pdu, format);
        return msgs;
    }
    ...
    private SmsMessage[] genLongSMS() {
        ...
        msgs[0] = SmsMessage.createFromPdu(pdu0, format);
        msgs[1] = SmsMessage.createFromPdu(pdu1, format);
        return msgs;
    }
