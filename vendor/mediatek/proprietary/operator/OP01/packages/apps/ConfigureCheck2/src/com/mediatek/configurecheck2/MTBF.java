...
class CheckUrl extends CheckItemBase {
    ...
    private static final String TEXT_C =
        "http://42.96.171.2/download.jsp?dir=text&name=Text.txt";
    private static final String MP3_C =
        "http://42.96.171.2/download.jsp?dir=music&name=mp3.mp3";
    private static final String JPG_C =
        "http://42.96.171.2/download.jsp?dir=image&name=Picture.jpg";
    private static final String GP3_C =
        "http://42.96.171.2/download.jsp?dir=video&name=3GP.3gp";
    ...
    CheckUrl(Context c, String key) {
        ...
        cc = c;
        setProperty(PROPERTY_AUTO_CHECK | PROPERTY_AUTO_CONFG);
        if (key.equals(CheckItemKeySet.CI_BROWSER_URL)) {
        setTitle(R.string.title_bookmark);
        } else {
            setTitle(R.string.title_bookmark_comcat);
        }
    ...
    public boolean onCheck() {
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                if (getKey().equals(CheckItemKeySet.CI_BROWSER_URL)) {
                    id2 = syncBookmark("Text", TEXT);
                    id3 = syncBookmark("Mp3", MP3);
                    id4 = syncBookmark("Jpg", JPG);
                    id5 = syncBookmark("3gp", GP3);
                } else {
                    id2 = syncBookmark("CText", TEXT_C);
                    id3 = syncBookmark("CMp3", MP3_C);
                    id4 = syncBookmark("CJpg", JPG_C);
                    id5 = syncBookmark("C3gp", GP3_C);
                }
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                deleteSameUrl(GP3, 1);
                    ...
                    deleteSameUrl(TEXT_C, 1);
                    deleteSameUrl(MP3_C, 1);
                    deleteSameUrl(JPG_C, 1);
                    deleteSameUrl(GP3_C, 1);
                }
                ...
                if (getKey().equals(CheckItemKeySet.CI_BROWSER_URL)) {
                    ...
                    addBookmark("C3gp", GP3_C);
                    addBookmark("CText", TEXT_C);
                    addBookmark("CJpg", JPG_C);
                    addBookmark("CMp3", MP3_C);
                }
...
class CheckShortcut extends CheckItemBase {
    ...
    private static final String FAVORITENAME = "com.mediatek.myfavorite";
    ...
    private static final String MP3NAME = "Mp3";
    private static final String JPGNAME = "Jpg";
    private static final String GP3NAME = "3gp";
    private static final String STREAMING1NAME = "Strea";
    private static final String TEXTURL =
        "http://42.96.171.2/download.jsp?dir=text&name=Text.txt";
    private static final String MP3URL =
        "http://42.96.171.2/download.jsp?dir=music&name=mp3.mp3";
    private static final String JPGURL =
        "http://42.96.171.2/download.jsp?dir=image&name=Picture.jpg";
    private static final String GP3URL =
        "http://42.96.171.2/download.jsp?dir=video&name=3GP.3gp";
    private static final String STREAMING1URL =
        "http://42.96.171.2/list/rtsp.jsp";
    ...
    public boolean onReset() {
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                deleteShortcut(FAVORITENAME, "com.mediatek.myfavorite.MyFavorite");
                ...
                deleteBookmarkShortcut(TEXTNAME, TEXTURL);
                deleteBookmarkShortcut(MP3NAME, MP3URL);
                deleteBookmarkShortcut(JPGNAME, JPGURL);
                deleteBookmarkShortcut(GP3NAME, GP3URL);
                deleteBookmarkShortcut(STREAMING1NAME, STREAMING1URL);
                ...
                createShortcut(FAVORITENAME, "com.mediatek.myfavorite.MyFavorite");
                ...
                createBookmarkShortcut(TEXTNAME, TEXTURL);
                createBookmarkShortcut(MP3NAME, MP3URL);
                createBookmarkShortcut(JPGNAME, JPGURL);
                createBookmarkShortcut(GP3NAME, GP3URL);
                createBookmarkShortcut(STREAMING1NAME, STREAMING1URL);
...
class CheckRedScreen extends CheckItemBase {
    ...
    private StringBuffer systemexec(String command) {
        ...
        try {
            ...
            e.printStackTrace();
            CTSCLog.e(TAG, "InterruptedException Operation failed.");
        }
        return output;
    }
}
...
class CheckAddCallLog extends CheckItemBase {
    ...
    public boolean onReset() {
        ...
        try {
            // May block.
            Calls.addCall(null, getContext(), "10086", 0, 2, 0, null, System.currentTimeMillis(), 0, new Long(0));
        } catch (Exception e) {
