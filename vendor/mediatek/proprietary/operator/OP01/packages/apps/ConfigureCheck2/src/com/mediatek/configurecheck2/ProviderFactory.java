...
public class ProviderFactory {
    ...
    public static CheckItemProviderBase getProvider(Context c, String category) {
        ...
        } else if (category.equals(c.getString(R.string.VOLTE_Audio_Electric_Test))) {
            return new VolteAudioElectricCaseProvider(c);            
...
final class CheckItemKeySet {
   ...
   // public static final String CI_MODEM_SWITCH_SGLTE = "ModemSwitchSglte";
    ...
    public static final String CI_AUTO_ANSWER = "AutoAnswer";
    public static final String CI_JBM = "JBM";
    public static final String CI_APN_MOS = "MOS";
}
...
class TTCN3GProvider extends CheckItemProviderBase {
    TTCN3GProvider(Context c) {
        ...
        if (SystemProperties.get("ro.mtk_gemini_support").equals("1") == true &&  SystemProperties.get("ro.mtk_dt_support").equals("1") == false) {
...
class VolteAudioElectricCaseProvider extends CheckItemProviderBase {
    VolteAudioElectricCaseProvider(Context c) {                 
        mArrayItems.add(new CheckAtciInEM(c, CheckItemKeySet.CI_ATCI_IN_EM_ENABLE));
        mArrayItems.add(new CheckLabAPN(c, CheckItemKeySet.CI_APN_MOS));
        mArrayItems.add(new CheckAutoAnswer(c, CheckItemKeySet.CI_AUTO_ANSWER));
        mArrayItems.add(new CheckJBM(c, CheckItemKeySet.CI_JBM));
    }
}
