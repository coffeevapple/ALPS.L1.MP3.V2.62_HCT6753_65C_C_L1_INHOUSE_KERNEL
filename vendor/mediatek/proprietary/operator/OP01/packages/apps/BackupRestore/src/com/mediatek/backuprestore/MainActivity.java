...
public class MainActivity extends Activity {
    ...
    private void initPath() {
        ...
        if( StorageSettingsActivity.getCurrentPath(this) == null) {
            if(SDCardUtils.isSupprotSDcard() && SDCardUtils.getSDCardDataPath() != null ) {
                storagePath = SDCardUtils.getSDCardDataPath();
                indexKey = Constants.SDCARD_STOTAGE;
            } else {
                storagePath = SDCardUtils.getPhoneDataPath();
                indexKey = Constants.PHONE_STOTAGE;
            }
            MyLogger.logD(CLASS_TAG, "initPath : storagePath = "+ storagePath +", indexKey = "+ indexKey);
...
/*        actionBar.setDisplayOptions(ActionBar.DISPLAY_SHOW_CUSTOM,
    ...
    protected Dialog onCreateDialog(int id, Bundle args) {
        ...
        case DialogID.DLG_SCANN_INFO:
            dialog = new AlertDialog.Builder(this).setIconAttribute(android.R.attr.alertDialogIcon)
                    .setTitle(R.string.remind).setMessage(R.string.scanner_all_notice).setCancelable(false)
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
