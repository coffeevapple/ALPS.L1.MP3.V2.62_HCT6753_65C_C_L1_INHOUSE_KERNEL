...
public class BackupTabFragment extends ListFragment {
    ...
    private void initAdapter() {
        String[] content = new String[] { getString(R.string.backup_personal_data), getString(R.string.backup_app) };
   ...
   /* @Override
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && data != null) {
            ...
            case Constants.RESULT_PERSON_DATA:
                mPersonData = data.getExtras();
                Log.i(CLASS_TAG, "onActivityResult mPersonData = " + mPersonData);
                break;
            case Constants.RESULT_APP_DATA:
                mAppData = data.getExtras();
                Log.i(CLASS_TAG, "onActivityResult mAppData = " + mAppData);
                break;
            default:
                break;
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        Log.i(CLASS_TAG, "onSaveInstanceState mPersonData = " + sPersonData + ", mAppData = " + sAppData);
