    ...
    public boolean implementComposeOneEntity() {
        ...
        for (int i = 0; i < mSmsCursorArray.length; ++i) {
            if (mSmsCursorArray[i] != null && !mSmsCursorArray[i].isAfterLast()) {
                ...
                // long subid = tmpCur.getLong(tmpCur.getColumnIndex(COLUMN_NAME_SUB_ID));
                String mSlotid = "0";
                ...
                MyLogger.logD(CLASS_TAG, "is gemini = " + SystemProperties.get("ro.mtk_gemini_support").equals("1")
                        + ",subid:" + subid + ",mSlotid:" + mSlotid);
