...
public class AppRestoreComposer extends Composer {
    ...
    public boolean implementComposeOneEntity() {
        ...
        try {
            ...
            if (!isCtsLoad) {
                ...
                result = appDataRestore(installObserver.mPackageName, apkFileName);
    ...
    public boolean appDataRestore(String packageName,String apkName) {
        boolean result = true;
        ...
        String appDataTar = apkName.substring(0,apkName.length() - 3) + "tar";
    ...
    public void onStart() {
        ...
        intent.setClassName("com.mediatek.backuprestore.modules", "com.mediatek.backuprestore.modules.AidlService");
        try {
