...
/*    @Override
    ...
    public void executeRestoreCommand(final String path) {
        ...
        if(file != null) {
            if (file.getParent().equals(SDCardUtils.getSdCardMountPath() + File.separator + ".backup")) {
                isOldBackup = true;
                MyLogger.logD(CLASS_TAG, "RestoreService : the path is old Data and isOldBackup = " + isOldBackup);
            }
        }
