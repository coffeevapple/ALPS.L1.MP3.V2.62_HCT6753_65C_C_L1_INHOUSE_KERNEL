...
public class PersonalDataBackupActivity extends AbstractBackupActivity implements OnCheckedCountChangedListener,
                ...
                R.string.btn_ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (!SDCardUtils.isSupprotSDcard()
                                && !StorageSettingsActivity.getNoticeStatus(getApplicationContext(),
    ...
    private void initContactConfig() {
        ...
        mContactItemData = new ContactItemData(-1, mContactCheckedTemp[0], getString(R.string.contact_phone),
                this.getResources().getDrawable(R.drawable.contact_phone_storage));
        ...
        if (mSimInfoList != null) {
            for (int i = 0; i < mSimInfoList.size(); i++) {
                ...
                if (simInfo != null) {
                    Drawable simIcon = new BitmapDrawable(this.getResources(), simInfo.createIconBitmap(PersonalDataBackupActivity.this));
                    mContactItemData = new ContactItemData(simInfo.getSimSlotIndex(),
                            mContactCheckedTemp[i + 1], simInfo.getDisplayName().toString(), simIcon);
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        if (editor != null) {
                            ...
                            String path = SDCardUtils.getPersonalDataBackupPath(StorageSettingsActivity.getCurrentPath(getApplicationContext()));
                            if (path == null) {
