...
public class FileUtils {
    ...
    public static ArrayList<File> getAllApkFileInFolder(String[] apkData) {
        if (apkData == null) {
            return null;
        }
        ...
        for (String apkPath : apkData) {
            File apkFile = new File(apkPath);
            if (apkFile != null && apkPath.endsWith("apk")) {
                list.add(apkFile);
            }
        }
        return list;
...
// L migration modify, by Na Wang 2014.7.29
...
//        metrics.setToDefaults();
        ...
        // L migration modify, by Na Wang 2014.7.29 end.
        if (pkg == null) {
            return null;
        }
