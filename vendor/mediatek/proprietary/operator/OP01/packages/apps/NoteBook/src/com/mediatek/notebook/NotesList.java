...
public class NotesList extends ListActivity implements OnItemLongClickListener {
    ...
    private ContentObserver mNotesChangedObserver = new ContentObserver(new Handler()) {

        public void onChange(boolean selfChange) {
            Log.d(TAG, "mNotesChangedObserver changed");    
            queryUpdateData();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getContentResolver().registerContentObserver(Notes.CONTENT_URI, true, mNotesChangedObserver);
    ...
    protected void onDestroy() {
        ...
        getContentResolver().unregisterContentObserver(mNotesChangedObserver);
    }
