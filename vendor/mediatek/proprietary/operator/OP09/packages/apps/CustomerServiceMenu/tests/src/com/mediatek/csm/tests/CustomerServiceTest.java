...
public class CustomerServiceTest extends ActivityInstrumentationTestCase2<CustomerServiceMenu> {
    ...
    /**
     * Constructs a new CustomerServiceTest instance.
     */
    ...
    /**
     * TestCase: test Customer Hotline.
     */
    ...
    /**
     * TestCase: test self-service Hotline.
     */
    public void testSelfHotLine() {
        if (DEBUG) {
    ...
    /**
     * TestCase: test Mobile e-hall by Message.
     */
    public void testEhallMessage() {
        if (DEBUG) {
        ...
        waitForConnection();
        if (TelephonyManagerEx.getDefault().getPhoneType(simId)
    ...
    /**
     * TestCase: test Mobile e-hall by Wap.
     */
    public void testEhallWap() {
        if (DEBUG) {
    ...
    /**
     * TestCase: test unsubscribe Inquiry.
     */
    ...
    /**
     * TestCase: test Global Hotline.
     */
    public void testGlobalHotline() {
        if (DEBUG) {
    ...
    /**
     * TestCase: test Phone Service Guide.
     */
    ...
    private int checkSimState() {
        ...
        if (!PhoneManager.isSimInserted(PhoneConstants.SIM_ID_1) &&
                !PhoneManager.isSimInserted(PhoneConstants.SIM_ID_2)) {
            throw new IllegalStateException("No SIM card inserted");
        }
        if (PhoneManager.isSimInserted(PhoneConstants.SIM_ID_1)) {
            TelephonyManagerEx tpm = TelephonyManagerEx.getDefault();
            final int type01 = tpm.getPhoneType(PhoneConstants.SIM_ID_1);
            final int type02 = tpm.getPhoneType(PhoneConstants.SIM_ID_2);
