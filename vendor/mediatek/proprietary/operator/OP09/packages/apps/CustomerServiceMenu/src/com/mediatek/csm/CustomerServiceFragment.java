...
/**
 * A custom PreferenceFragment that displays Customer Service.
 */
public class CustomerServiceFragment extends PreferenceFragment {
    ...
    public static final String ACTION_SENDTO_DELIVERED =
    ...
    public int getSimId() {
        ...
        if (PhoneManager.isGeminiSupport()) {
            Xlog.d(LOG_TAG, "Gemini SIM card!");
            /// M: For L.AOSP.EARLY.DEV @{
            final int sim01 = PhoneConstants.SIM_ID_1;
            final int sim02 = PhoneConstants.SIM_ID_2;
            /// @}
            ...
            /// M: For L.AOSP.EARLY.DEV
            final int sim = PhoneConstants.SIM_ID_1;
    ...
    /**
     * Check to see if need to Check ConnectState.
     * @param simId sim slot
     * @return returns true if need check ConnectState.
     */
     ...
     * @param simId sim slot
     * @param request Connect Request Type
     * @param r Runnable on service complete.
     */
    ...
    /**
     * Check to see if the Sim State is available or not.
     * @param simId sim slot
     * @return returns true if the Sim State is available.
     */
     ...
     * @param simId sim slot
     * @param addressId the address resource id to send the message to.
     * @param msgId the body of the message resource id to send.
     */
     ...
     * Call.
     * @param simId sim slot
     * @param addressId the address resource id to call to.
     */
    ...
    /**
     * Show info toast from a resource.
    ...
    /**
     * To make title text for Sms progress dialog.
