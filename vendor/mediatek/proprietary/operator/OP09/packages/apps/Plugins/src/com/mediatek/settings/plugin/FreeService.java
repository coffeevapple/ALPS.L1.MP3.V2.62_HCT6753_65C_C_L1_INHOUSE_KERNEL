...
public class FreeService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        ...
        Xlog.v(TAG, "dialUsingAccount, simStatus=" + simStatus);
    ...
    private void dialUsingAccount(int slotId, Intent intent) {
        ...
        Xlog.v(TAG, "dialUsingAccount, slotId = " + slotId + ",subIds = " + subIds);
        if (subIds != null && subIds.length != 0) {
            int subId = subIds[0];
            Xlog.v(TAG, "dialUsingAccount, slotId = " + slotId + ",subId = " + subId);
            if (subId != -1) {
