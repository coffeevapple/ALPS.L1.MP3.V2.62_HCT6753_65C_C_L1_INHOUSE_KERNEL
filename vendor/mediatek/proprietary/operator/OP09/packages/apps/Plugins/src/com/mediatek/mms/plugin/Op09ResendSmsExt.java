...
/**
 * M: for op09 , resend sms.
 */
@PluginImpl(interfaceName = "com.mediatek.mms.ext.IResendSmsExt")
public class Op09ResendSmsExt extends DefaultResendSmsExt {
    ...
    public void resendMessage(final Context context, final Uri uri, final long subId) {
        Xlog.d(TAG, "ResendSmsExt.resendMessage");
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                Xlog.d(TAG, "Move message to queued box: " + isMoved);
