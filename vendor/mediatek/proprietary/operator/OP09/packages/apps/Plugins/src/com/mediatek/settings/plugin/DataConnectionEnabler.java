...
public final class DataConnectionEnabler implements CompoundButton.OnCheckedChangeListener {
    ...
    private int update_action = 0;
    private String observe_sim1;
    private String observe_sim2;
    ...
    private void updateSwitcherState() {
        ...
        if (update_action == 1) {
            enable_before = mTelephonyManager.getDataEnabled();
            if (enable_before) {
                ...
                mSwitch.setChecked(true);
                    ...
                    List<SubscriptionInfo> si =  SubscriptionManager.from(mContext)
                     ...
                     if (si != null && si.size() > 0) {
                      ...
                      Log.d(TAG, "update_action 1  tmp = " + tmp);
                      if (tmp) {
                          mSwitch.setChecked(true);
                      } else {
