 ...
 */
@PluginImpl(interfaceName = "com.mediatek.mms.ext.IMmsAdvanceSearchExt")
public class Op09MmsAdvanceSearchExt extends DefaultMmsAdvanceSearchExt {
    ...
    public Uri buildAdvanceSearchUri() {
        ...
        Xlog.d(TAG, "buildAdvanceSearchUri: uri:" + builder.build().toString());
        return builder.build();
    }

    @Override
    public void initAdvancedData(Intent intent) {
        Xlog.d(TAG, "initAdvancedData");
