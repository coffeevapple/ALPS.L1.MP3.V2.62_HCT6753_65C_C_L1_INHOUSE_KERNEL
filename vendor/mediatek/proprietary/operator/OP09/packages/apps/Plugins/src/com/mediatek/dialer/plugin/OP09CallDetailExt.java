...
public class OP09CallDetailExt extends DefaultCallDetailExtension {
	...
	private static final String ITEM_INFO = "call_account_info";
    ...
    public void setCallAccountForCallDetail(Context context, PhoneAccountHandle phoneAccountHandle) {
        ...
        if (null == viewChild && null != iconBitmap) {
            ...
            LinearLayout iconLayout = (LinearLayout) mInflater.inflate(R.layout.ct_sim_indicator, null);
            ...
            callDetail.addView(iconLayout, 0);
        }
    }
