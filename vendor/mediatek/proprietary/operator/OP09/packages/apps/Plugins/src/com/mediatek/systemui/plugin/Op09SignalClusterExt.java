...
import static com.mediatek.systemui.ext.NetworkType.Type_1X3G;
import static com.mediatek.systemui.ext.NetworkType.Type_4G;
 ...
 */
public class Op09SignalClusterExt extends BaseSignalClusterExt {
    ...
    private boolean is4GDataOnlyMode() {
        return SvLteController.is4GDataOnlyMode(mContext);
    }
