...
public class CurrentNetworkInfoStatus extends PreferenceActivity {
    ...
    private void createPhoneStateListener() {
        mPhoneStateListener = new PhoneStateListener(mSubId) {
            ...
            public void onSignalStrengthsChanged(SignalStrength signalStrength) {
                Xlog.d(TAG, "onSignalStrengthsChanged, mSlotId : " + mSlotId +
            ...
            public void onServiceStateChanged(ServiceState serviceState) {
                Xlog.d(TAG, "onServiceStateChanged, mSlotId : " + mSlotId + ", VoiceRegState : "
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (subId != null) {
            ...
            Xlog.e(TAG, "invoke finish in onCreate,because subId array i;s null");
            mIsAborting = true;
            finish();
        }
        if (!SubscriptionManager.isValidSubscriptionId(mSubId)) {
            Xlog.e(TAG, "invoke finish in onCreate,because mSubId is invalid");
            mIsAborting = true;
            finish();
        }
        Xlog.d(TAG, "onCreate, mSlotId is : " + mSlotId + ", mSubId is : " + mSubId);
    ...
    private void initPreferences() {
        ...
        if (mPhone != null) {
            ...
            Xlog.d(TAG, "mPhone == null, finish() ");
            mIsAborting = true;
            finish();
        }
        Xlog.d(TAG, "initPreferences, slotId = " + mSlotId + " phoneType = " + phoneType);
    ...
    private void getSidNidPrlValue() {
        ...
        Xlog.d(TAG, "getSidNidPrlValue: key = " + PRL_VERSION_KEY_NAME +
    ...
    private boolean isLteDataNwReg() {
        boolean isLteDataNW = false;
         ...
         Xlog.d(TAG, "isLteDataNwReg: " + isLteDataNW + ", CdmaPhone active : "
    ...
    void updateSignalStrength() {
        ...
        if (mSignalStrengthPreference != null) {
            ...
            Xlog.d(TAG, "updateSignalStrength, SignalStrength is " + signalDbm + " dbm , "
                    + signalAsu + " asu");
            ...
            if (!isGsmSignal && isLteDataNwReg()) {
                ...
                Xlog.d(TAG, "updateSignalStrength, LTE SignalStrength is "
    ...
    private boolean checkTargetSlotEnable() {
        ...
        try {
            if (telephony != null) {
                isRadioInOn = telephony.isRadioOnForSubscriber(mSubId);
                Xlog.d(TAG, "Slot " + mSlotId + " is in radion state " + isRadioInOn);
            }
        } catch (RemoteException e) {
            Xlog.e(TAG, "Telephony exception");
        }
        return isRadioInOn;
