...
public class Op08DatabaseHelperExt extends DefaultDatabaseHelperExt {

    private static final String TAG = "Op08DatabaseHelperExt";
    private Context mContext;
    /**
     * @param context Context
     * constructor
     */
    public Op08DatabaseHelperExt(Context context) {
         super(context);
         mContext = context;
    }
    ...
    public String getResInteger(Context context, String name, String defaultValue) {
        ...
        if (Settings.System.SELECTED_WFC_PREFERRENCE.equals(name)) {
            res  = Integer.toString(mContext.getResources().getInteger(
                        R.integer.def_selected_wfc_preference_op08));
        } else {
