...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        512,       // i4B_MIN
                { // i4P00[9]
               4604584, -1906373, -138211, -588914, 3963381, -814467, -19211, -1402749, 3981960
                },
                { // i4P10[9]
                    0,  0, 0, 0,  0,  0, 0,   0, 0              
                },
 ...
 // Predictor gain
 {
	...
	{							                                
		...
		{						                                
			...
			-383,	// PCloudyUpperBound				        
			-499	// PCloudyLowerBound				        
		},						                              
		// Shade						                        
		{						                                
			397,	// PShadeRightBound				          
			122,	// PShadeLeftBound				          
			-383,	// PShadeUpperBound				          
			-499	// PShadeLowerBound				          
		},						                              
		// Twilight						                      
		{						                                
			-7,	// PTwiRightBound				            
		...
		{						                                
			...
			-398,	// PWFluoLeftBound				          
			-373,	// PWFluoUpperBound				          
			-590	// PWFluoLowerBound				          
		},						                              
		// Incandescent						                  
		{						                                
			-198,	// PIncaRightBound				          
	...
	{							                                
		...
		// Sunset Area						                        
		{						                                
			58,	// i4Sunset_BoundXr_Thr				                
			-477	// i4Sunset_BoundXr_Thr				                  
		},						                              
		// Sunset Vertex						                        
		{						                                
			58,	// i4Sunset_VertexXr_Thr				                
			-477	// i4Sunset_VertexXr_Thr				                  
		},						                              
		// Shade F Area					                        
		{						                                
			-169,	// i4Sunset_BoundXr_Thr				                
			-462	// i4Sunset_BoundXr_Thr				                  
		},						                              
		// Shade F Vertex						                        
		{						                                
			-169,	// i4Sunset_BoundXr_Thr				                
			-481	// i4Sunset_BoundXr_Thr				                  
		},						                              
		// Shade CWF Area					                        
		{						                                
			-169,	// i4Sunset_BoundXr_Thr				                
			-544	// i4Sunset_BoundXr_Thr				                  
		},						                              
		// Shade CWF Vertex					                        
		{						                                
			-169,	// i4Sunset_BoundXr_Thr				                
			-570	// i4Sunset_BoundXr_Thr				                  
		},						                              
		// Low CCT Area						                        
		{						                                
			-452,	// i4Sunset_BoundXr_Thr				                
			185	// i4Sunset_BoundXr_Thr				                  
		},						                              
		// Low CCT Vertex					                        
		{						                                
			-452,	// i4Sunset_BoundXr_Thr				                
	...
	{							                                
		...
		{						                                
			...
			-440,	// RotatedXCoordinate1				      
			-225,	// RotatedXCoordinate2				      
