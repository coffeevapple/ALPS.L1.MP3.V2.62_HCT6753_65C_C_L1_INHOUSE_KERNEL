...
*/
			...
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				if (arg1.getAction() == MotionEvent.ACTION_DOWN)
				{
					...
					mtc_file_list.add("high temp 120deg C");
					{
				        ...
				        FilenameFilter only = new ExtensionFilter("mtc");
				        File[] data_file_list = data_dir.listFiles(only);
    ...
    if (((CompoundButton) thermal_logger_switch).equals(buttonView))
    {
      if (isChecked)
      {
        ...
        else
        {
          ...
          writeFile("/proc/driver/thermal/mtm_monitor", "1 "+ctstr);
      ...
      else
      {
        if (isThermalLoggerEnabled())
        {
          ...
          writeFile("/proc/driver/thermal/mtm_monitor", "0");
  ...
  private void executeShellCommand(String shellCommand)
  {
    ...
    finally
    {
      if (null != osw)
      {
        try
        {
          ...
          Xlog.d("MTKThermalManagerActivity", "IOE\n");
        }
      }
    }
    ...
    try
    {
      ...
      Xlog.d("MTKThermalManagerActivity", "Interrupted\n");
    }
