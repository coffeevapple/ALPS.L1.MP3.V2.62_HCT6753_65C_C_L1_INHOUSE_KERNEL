...
public class HetCommReceiver extends BroadcastReceiver {
    ...
    private void checkHetCommService(Context context) {
        SharedPreferences sharedPref = context.getSharedPreferences(HetCommActivity.ALL_SETTINGS, 0);
        boolean isEnabled = sharedPref.getBoolean(HetCommActivity.HET_COMMON_SETTING, false);
