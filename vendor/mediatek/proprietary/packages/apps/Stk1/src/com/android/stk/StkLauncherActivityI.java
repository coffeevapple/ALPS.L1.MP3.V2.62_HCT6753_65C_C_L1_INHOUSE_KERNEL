...
public class StkLauncherActivityI extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (service != null && service.StkQueryAvailable(PhoneConstants.SIM_ID_1) != StkAppService.STK_AVAIL_AVAILABLE)
        {
            ...
            } else if (true == isOnLockMode(PhoneConstants.SIM_ID_1) ||
                    false == isRadioOnState(PhoneConstants.SIM_ID_1)) {
    ...
    boolean isRadioOnState(int slotId) {
        ...
        CatLog.d("Stk-LA", "isRadioOnState check = " + slotId);
        ...
        try {
            ...
            CatLog.d("Stk-LA", "isRadioOnState - radio_on[" + radioOn + "]");
        } catch (RemoteException e) {
            e.printStackTrace();
            CatLog.d("Stk-LA", "isRadioOnState - Exception happen ====");
        }
        return radioOn;
    }
}
