...
public class StkAppService extends Service implements Runnable {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        if (intent == null) {
            CatLog.d(LOG_TAG, "onStart, intent is null.");
            return;
        }
...
*/
    ...
    private void handleSessionEnd(int slotId) {
        ...
        // In mutiple instance architecture, the main menu for slotId will be finished when user goes to 
        // the Stk menu of other SIM.So, we should launch a new main menu if the main menu 
...
*/
    ...
    private void handleCmd(CatCmdMessage cmdMsg, int slotId) {
        ...
        case SELECT_ITEM:
            ...
            if (iTel != null) {
                try {
                    int subId[] = SubscriptionManager.getSubId(slotId);
                    if(iTel.isRadioOnForSubscriber(subId[0]) == true) {
    ...
    private void processOpenChannelResponse(int slotId) {
        ...
        switch (iChannelType) {
            ...
            default: /* Error! */
                CatLog.d(LOG_TAG, "processOpenChannelResponse() Error channel type[" + iChannelType + "]");
        ...
        if (mStkContext[slotId].mCurrentCmd != null) {
            ...
            case SET_UP_CALL:
                ...
                if(null != phone) {
                    ...
                    CatLog.d(this, "Phone is null. assume state is idle.");
                }
...
*/
   ...
   */
    ...
    private void  handleIdleTextResponse(int slotId) {
        ...
        if (null != mStkContext[slotId].mCurrentCmd && null != mStkContext[slotId].mCurrentCmd.getCmdType())
            CatLog.d(LOG_TAG, "handleIdleTextResponse cmdName[" + mStkContext[slotId].mCurrentCmd.getCmdType().name() + "]");
        mStkService[slotId].onCmdResponse(resMsg);
    }
