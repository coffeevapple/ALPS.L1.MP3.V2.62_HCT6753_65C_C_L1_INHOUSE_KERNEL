...
public class StkLauncherActivityII extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (service != null && service.StkQueryAvailable(PhoneConstants.SIM_ID_2) != StkAppService.STK_AVAIL_AVAILABLE)
        {
            ...
            } else if (true == isOnLockMode(PhoneConstants.SIM_ID_2) ||
                    false == isRadioOnState(PhoneConstants.SIM_ID_2)) {
    ...
    boolean isOnLockMode(int slotId) {
        ...
        CatLog.d("Stk-LAII", "lock mode is " + simState);
    ...
    boolean isRadioOnState(int slotId) {
        ...
        CatLog.d("Stk-LAII", "isRadioOnState check = " + slotId);
        ...
        try {
            ...
            CatLog.d("Stk-LAII", "isRadioOnState - radio_on[" + radioOn + "]");
        } catch (RemoteException e) {
            e.printStackTrace();
            CatLog.d("Stk-LAII", "isRadioOnState - Exception happen ====");
        }
        return radioOn;
    }
}
