...
public class NotificationAlertActivity extends Activity {
    ...
    private static final String LOG_TAG = "Stk-NA ";
...
//        }
        ...
        CatLog.d(LOG_TAG, "NotificationAlertActivity, sim id: " + sim_id);
        ...
        CatLog.d(LOG_TAG, "Idle Text[" + mNotificationMessage + "]");
