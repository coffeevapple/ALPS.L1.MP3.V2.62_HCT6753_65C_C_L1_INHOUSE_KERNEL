...
public class StkLauncherActivityIV extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (service != null && service.StkQueryAvailable(PhoneConstants.SIM_ID_4) != StkAppService.STK_AVAIL_AVAILABLE)
        {
            ...
            } else if (true == isOnLockMode(PhoneConstants.SIM_ID_4) ||
                    false == isRadioOnState(PhoneConstants.SIM_ID_4)) {
    ...
    boolean isOnLockMode(int slotId) {
        ...
        CatLog.d("Stk-LAIV", "lock mode is " + simState);
    ...
    boolean isRadioOnState(int slotId) {
        ...
        CatLog.d("Stk-LAIV", "isRadioOnState check = " + slotId);
        ...
        try {
            ...
            CatLog.d("Stk-LAIV", "isRadioOnState - radio_on[" + radioOn + "]");
        } catch (RemoteException e) {
            e.printStackTrace();
            CatLog.d("Stk-LAIV", "isRadioOnState - Exception happen ====");
        }
        return radioOn;
    }
}
