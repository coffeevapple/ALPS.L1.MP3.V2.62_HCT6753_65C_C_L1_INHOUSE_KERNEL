...
public class BlackListAdapter extends ContactBaseAdapter {
    ...
    private void infalteContactItemView(View view, final ViewHolder holder,
            int position) {
        holder.name = (TextView) view.findViewById(R.id.black_list_item_name);
        holder.blockedTime = (TextView) view
                .findViewById(R.id.black_list_item_time);
        ...
        holder.contactItemLayout = (RelativeLayout) view
                .findViewById(R.id.black_list_item_layout);
    ...
    private void updateContactItemView(View view, final ViewHolder holder,
            int position) {
        holder.name.setText(mContactsList.get(position).mDisplayName);
        holder.firstLetter.setVisibility(View.GONE);
        holder.contactItemLayout.setVisibility(View.VISIBLE);
