...
public class AppSettings {
    ...
    public boolean isEnabledCompressingImageFromDB() {
        ...
        if (sInstance != null) {
            ...
            if (LOGGER.isActivated()) {
                LOGGER.debug("isEnabledCompressingImageFromDB(), result: "
                        + result);
            }
    ...
    public void saveRemindWarningLargeImageFlag(final boolean notRemindFlag) {
        if (LOGGER.isActivated()) {
            LOGGER.debug("saveRemindWarningLargeImageFlag(), notRemindFlag: "
                    + notRemindFlag);
        }
    ...
    public boolean restoreRemindWarningLargeImageFlag() {
        ...
        if (sInstance != null) {
            ...
            if (LOGGER.isActivated()) {
                LOGGER.debug("restoreRemindWarningLargeFlag(), result: "
                        + result);
            }
            return Boolean.valueOf(result);
        }
    ...
    public Boolean isEnableFtAutoAcceptWhenNoRoaming() {
        ...
        if (LOGGER.isActivated()) {
            LOGGER.debug("isEnableFtAutoAcceptWhenNoRoaming() result: "
                    + result);
        }
        return result;
    }
    ...
    public void setEnableFtAutoAcceptWhenNoRoaming(Boolean enable) {
        ...
        if (LOGGER.isActivated()) {
            LOGGER.debug("setEnableFtAutoAcceptWhenNoRoaming() enable: "
                    + enable);
        }
    }
    ...
    public void registerWallPaperChangedListener(
        ...
        if (LOGGER.isActivated()) {
            LOGGER.debug("registerWallPaperChangedListener, listener: "
                    + listener);
        }
    ...
    public String getChatWallpaper() {
        if (LOGGER.isActivated()) {
            LOGGER.debug("getChatWallpaper() from memory, mChatWallpaper: "
                    + mChatWallpaper);
        }
