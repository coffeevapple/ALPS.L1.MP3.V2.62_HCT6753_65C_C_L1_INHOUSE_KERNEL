...
public class IpMessagePluginExt extends IpMessagePluginImpl implements
    ...
    public ResourceManager getResourceManager(Context context) {
        Logger.d(
                TAG,
                "getResourceManager() entry! context = "
    ...
    public ActivitiesManager getActivitiesManager(Context context) {
        Logger.d(
                TAG,
                "getActivitiesManager() entry! context = "
                        + context.getApplicationInfo().packageName);
        if (!PluginUtils.isRCSeConfigured()) {
    ...
    public SettingsManager getSettingsManager(Context context) {
        Logger.d(
                TAG,
                "getSettingsManager() entry! context = "
                        + context.getApplicationInfo().packageName);
        if (!PluginUtils.isRCSeConfigured()) {
    ...
    public boolean isActualPlugin() {
        ...
        if (!dbFile.exists()) {
            ...
            if (RcsSettings.getInstance() == null) {
                Logger.d(TAG, "RcsSettings is null");
                RcsSettings.createInstance(AndroidFactory
                        .getApplicationContext());
            }
