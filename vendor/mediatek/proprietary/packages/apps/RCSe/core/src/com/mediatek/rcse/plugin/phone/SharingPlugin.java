...
public class SharingPlugin implements ICallScreenPlugIn,
    ...
    public boolean isImageShareSupported(String number) {
        ...
        boolean isImageShareSupported = PluginApiManager
                .getInstance().isImageShareSupported(vodafoneAccount);
        Logger.w(TAG,
    ...
    public boolean isVideoShareSupported(String number) {
        ...
        boolean isVideoShareSupported = PluginApiManager
                .getInstance().isVideoShareSupported(vodafoneAccount);
        Logger.v(TAG,
    ...
    public void onCapabilitiesChanged(String contact,
        ...
        String number = getVodafoneAccount(sNumber);
    ...
    public void onPhoneStateChange(CallManager cm) {
        ...
        if (hasActiveBgCall ^ mIsOnHold) {
            ...
            numbers.add(getVodafoneAccount(sNumber));
            ...
            if (api != null) {
                ...
                if (capabilities != null) {
                    ...
                    api.getContactCapabilities(getVodafoneAccount(sNumber));
                } else {
    ...
    protected String getVodafoneAccount(String normalNumber) {
        ...
        if (normalNumber != null) {
            try {
                ...
                Logger.w(TAG,
                        "getVodafoneAccount() entry, normalNumber: "
                                + "myNumber:" + sNumber);
                if (number != null) {
                ...
                e.printStackTrace();
                Logger.e(TAG,
                        "getVodafoneAccount() JoynServiceException, return null");
            }
        }
        // format to + country code xxx
        vodafoneAccount = PhoneUtils
                .formatNumberToInternational(vodafoneAccount);
        Logger.d(TAG, "getVodafoneAccount() exit, vodafoneAccount: "
                + vodafoneAccount);
