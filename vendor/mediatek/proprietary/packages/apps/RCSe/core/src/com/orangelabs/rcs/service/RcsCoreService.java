...
public class RcsCoreService extends Service implements CoreListener {
 ...
 public class CoreServiceWrapperStub extends ICoreServiceWrapper.Stub {
    ...
    @Override
    	...
    	{
    		if (logger.isActivated()) {
    			logger.debug("CoreServiceWrapperStub getChatServiceBinder() entry");
    		}
    		return chatApi;
    		}
    	@Override
    	...
    	{
    		if (logger.isActivated()) {
    			logger.debug("CoreServiceWrapperStub getFileTransferServiceBinder() entry");
    		}
            return ftApi;
    		}
    	...
    	{
    		if (logger.isActivated()) {
    			logger.debug("CoreServiceWrapperStub getGeolocServiceBinder() entry");
    		}  
    		return gshApi;
    	}
    	...
    	{
    		if (logger.isActivated()) {
    			logger.debug("CoreServiceWrapperStub getVideoSharingServiceBinder() entry");
    		}  
    		return vshApi;
    	}
    	...
    	{
    		if (logger.isActivated()) {
    			logger.debug("CoreServiceWrapperStub getImageSharingServiceBinder() entry");
    		}  
    		return ishApi;
    	}
    	
    	@Override
    	public IBinder getIPCallServiceBinder()
    	{
    		if (logger.isActivated()) {
    			logger.debug("CoreServiceWrapperStub getIPCallServiceBinder() entry");
    		}  
    		return ipcallApi;
    	}
    	
    	@Override
    	public IBinder getMultimediaSessionServiceBinder()
    	{
    		if (logger.isActivated()) {
    			logger.debug("CoreServiceWrapperStub getIPCallServiceBinder() entry");
    		}  
