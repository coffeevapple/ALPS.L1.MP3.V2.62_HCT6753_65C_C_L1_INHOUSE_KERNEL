...
import com.mediatek.rcse.ims.rcsua.RcsProxySipHandler;
...
public class TCPMessageChannel extends MessageChannel implements SIPMessageListener, Runnable,
    ...
    protected TCPMessageChannel(Socket sock, SIPTransactionStack sipStack,
		...
		if (isSingleRegisteration()) {
			...
			((RcsProxySipHandler) RcsUaAdapter.getInstance()
					.getSIPEventDispatcher()).addRCSSipEventListener(a);
		}
    ...
    protected TCPMessageChannel(InetAddress inetAddr, int port, SIPTransactionStack sipStack,
    	...
    	{
    	  eventListener a = new eventListener();
          ((RcsProxySipHandler) RcsUaAdapter.getInstance().getSIPEventDispatcher()).addRCSSipEventListener( a);
 ...
 public class eventListener extends RcsProxySipHandler.RcsSIPEventListener{
