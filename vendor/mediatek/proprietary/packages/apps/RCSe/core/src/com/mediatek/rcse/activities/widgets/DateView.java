...
public class DateView extends TextView {
    ...
    /**
     * Gets the index padding top.
     *
     * @return the index padding top
     */
    private int getIndexPaddingTop() {
        if (-1 == sIndexPaddingTop) {
            sIndexPaddingTop = sResources
                    .getDimensionPixelOffset(R.dimen.date_view_index_padding_top);
        }
     ...
     *
     * @param date the date
     * @param isTimeOnly the is time only
     * @return the string
     */
     ...
     * @return the string
     */
    private static String generateString(Date date, Context context,
            DATE_TIME_OPTION option) {
        ...
        case TIME_ONLY:
            ...
            timeString = DateUtils.formatDateTime(context, thenMillis,
                    formatFlags);
            break;
        case DATE:
        case TIME:
     ...
     * Checks if is today.
     *
     * @param todayMillis the today millis
     * @param thenMillis the then millis
    ...
    /**
     * Checks if is yesterday.
     *
     * @param todayMillis the today millis
     * @param thenMillis the then millis
     * @return true, if is yesterday
     */
    ...
    public void setTime(Date date, boolean isTimeOnly) {
        Logger.d(TAG, "setTime() entry, date: " + date + ", isTimeOnly: "
                + isTimeOnly);
        if (date != null) {
