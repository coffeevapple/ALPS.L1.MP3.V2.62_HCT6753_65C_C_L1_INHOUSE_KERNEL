...
public abstract class MessageChannel {
    ...
    {
    	return false;
    	//Since lowe layer is not ready yet
    	
       /* int networkLevel = NetworkUtils.getNetworkAccessType();
    	if(networkLevel == NetworkUtils.NETWORK_ACCESS_4G && RcsUaAdapter.getInstance().isSingleRegistration() )
    		return true;
    	return false;*/
    }
    ...
    {
	    ((RcsProxySipHandler) RcsUaAdapter.getInstance().getSIPEventDispatcher()).sendSipMsg(msg);
    }
