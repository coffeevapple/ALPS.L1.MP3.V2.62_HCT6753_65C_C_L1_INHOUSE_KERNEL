...
public class SettingsFragment extends PreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (PhoneUtils.sIsApnDebug) {
            ...
            mApnCheckBox
                    .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                        ...
                        public boolean onPreferenceClick(Preference preference) {
                            ...
                            RcsSettings.getInstance().setRcseOnlyApnState(
                                    checked);
                            return true;
                        }
                    });
            ...
            onlyApnIntent
                    .setAction(LauncherUtils.DEBUG_FORCEUSE_ONLYAPN_ACTION);
            onlyApnIntent.putExtra("forceUse", forceUse);
            Logger.d(TAG, "mRoamingCheckBox context: " + context
                    + " forceUse: " + forceUse);
            if (context != null) {
            ...
            mRoamingCheckBox
                    .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                        ...
                        public boolean onPreferenceClick(Preference preference) {
                            Context context = getActivity();
                            final boolean checked = mRoamingCheckBox
                                    .isChecked();
                            Intent onlyApnIntent = new Intent();
                            onlyApnIntent
                                    .setAction(LauncherUtils.DEBUG_FORCEUSE_ONLYAPN_ACTION);
                            onlyApnIntent.putExtra("forceUse", checked);
                            Logger.d(TAG, "mRoamingCheckBox context: "
                                    + context + " checked: " + checked);
                            if (context != null) {
                                context.getApplicationContext().sendBroadcast(
                                        onlyApnIntent);
                            }
                            // because it will be used in both UI process and
                            // core
                            // process, so we should make sure the status is
                            // correct in
                            // both processes.
                            mSettings.edit().putBoolean("forceUse", checked)
                                    .apply();
                            return true;
                        }
                    });
         ...
         * @}
         */
        boolean isSendReadReceiptChecked = mSettings.getBoolean(
    ...
    private class GetBlockNum extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            if (activity != null) {
                ...
                ArrayList<String> mBlocked = (ArrayList<String>) contactsManager
                        .getImBlockedContacts();
