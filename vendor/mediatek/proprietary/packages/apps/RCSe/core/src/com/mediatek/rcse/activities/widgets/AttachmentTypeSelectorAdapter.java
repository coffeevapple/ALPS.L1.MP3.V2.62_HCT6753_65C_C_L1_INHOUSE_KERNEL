...
public class AttachmentTypeSelectorAdapter extends IconListAdapter {
     ...
     *
     * @param whichButton
     *            The button that was clicked or the position of the item
     *            clicked.
    ...
    public static class AttachmentListItem extends IconListAdapter.IconListItem {
         ...
         * @param command
         *            The command will be executed when you click an item.
         */
