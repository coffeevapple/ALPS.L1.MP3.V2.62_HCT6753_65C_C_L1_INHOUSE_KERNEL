...
public class RoamingActivity extends Activity {
    ...
    public static final String ROAMING_MESSAGE_DIALOG_ACTION = "com.mediatek.rcse.activities.ROAMING_STATE";
    ...
    protected void onCreate(Bundle arg0) {
        ...
        if (intent != null) {
            int type = intent
                    .getIntExtra(RoamingActivity.EXTRA_ACTION_TYPE, -1);
    ...
    public class RoamingMessageDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            Builder dialogBuilder = new AlertDialog.Builder(
                    RoamingActivity.this, AlertDialog.THEME_HOLO_LIGHT);
            dialogBuilder.setTitle(this.getResources().getString(
                    R.string.rcs_message_dialog_title));
            // set display message
            if (mType == ROAMING_WITH_ENABLE) {
                Logger.d(TAG,
                        "Currently is roaming, and the 'Roaming' check box is selected.");
                ...
                Logger.d(TAG,
                        "Currently is roaming, and the 'Roaming' check box is unselected.");
                dialogBuilder.setMessage(this.getResources().getString(
            ...
            if (mType == ROAMING_WITH_DISABLE) {
                dialogBuilder.setNegativeButton(
                        this.getResources().getString(
                                R.string.rcs_dialog_negative_button),
                        new OnClickListener() {
                            @Override
            ...
            dialogBuilder.setPositiveButton(
                    this.getResources().getString(
                            R.string.rcs_dialog_positive_button),
                    new OnClickListener() {
                        @Override
                        public void onClick(DialogInterface arg0, int arg1) {
                            if (mType == ROAMING_WITH_ENABLE) {
                                ...
                                Logger.d(TAG,
                                        "onClick()-Currently is not roaming");
                                // Start the RCS-e service automatically
                                LauncherUtils
                                        .forceLaunchRcsCoreService(RoamingActivity.this
