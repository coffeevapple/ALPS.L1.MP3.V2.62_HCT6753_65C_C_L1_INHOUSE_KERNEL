...
/**
 * @author MTK33296 This Class creates a dialog alert to show when users first
 *         time boot the phone and register is failed on wifi because
 *         configuration/registration only allowed with sim on first time.
 *
 */
public class RegistrationStatusActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // Activity to show alert dialog for RCSE register failure at bootup
        // first time
