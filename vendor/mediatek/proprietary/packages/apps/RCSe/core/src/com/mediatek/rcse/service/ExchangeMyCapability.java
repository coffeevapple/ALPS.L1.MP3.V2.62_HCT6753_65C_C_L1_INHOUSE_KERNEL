...
public final class ExchangeMyCapability {
    ...
    public static synchronized ExchangeMyCapability getInstance(Context context) {
        Logger.d(TAG,
                "getInstance() of ExchangeMyCapability entry, sInstance is "
                        + sInstance);
        if (sInstance == null) {
    ...
    private ExchangeMyCapability(Context context) {
        ...
        mImageSharingCallApi = new ImageSharingService(context,
                new JoynServiceListener() {
        ...
        mVideoSharingCallApi = new VideoSharingService(context,
                new JoynServiceListener() {
    ...
    /*
     * private void getContactListOngoingImageSharingCall() { String
     * remotePhoneNumber = null; try { remotePhoneNumber = mImageSharingCallApi.
     * } catch (ClientApiException e) { e.printStackTrace(); } if
     * (remotePhoneNumber != null) { String phoneUri =
     * PhoneUtils.formatNumberToSipUri(remotePhoneNumber);
     * mContactList.add(phoneUri); } }
     * 
     * private void getContactListOngoingVideoSharingCall() { String
     * remotePhoneNumber = null; try { remotePhoneNumber =
     * mRichCallApi.getRemotePhoneNumber(); } catch (ClientApiException e) {
     * e.printStackTrace(); } if (remotePhoneNumber != null) { String phoneUri =
     * PhoneUtils.formatNumberToSipUri(remotePhoneNumber);
     * mContactList.add(phoneUri); } }
     */
