    ...
    public class ConfigMessageDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            Builder dialogBuilder = new AlertDialog.Builder(
                    ConfigMessageActicity.this, AlertDialog.THEME_HOLO_LIGHT);
            mTermsLayout = LayoutInflater.from(getActivity()).inflate(
                    R.layout.terms_dialog, null);
            dialogBuilder.setView(mTermsLayout);
            TextView subject = (TextView) mTermsLayout
                    .findViewById(R.id.message);
            final EditText pin = (EditText) mTermsLayout.findViewById(R.id.pin);
            if (mMessage != null) {
                        ...
                        new OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                if ((sPinRequired && !userPin.equals(""))
                                    ...
                                    Toast.makeText(ConfigMessageActicity.this,
