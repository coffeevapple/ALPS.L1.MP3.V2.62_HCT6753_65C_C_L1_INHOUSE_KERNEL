...
public class MessageParsing {
    ...
    public static void onChatMessageClick(View messageView) {
        ...
        if (spanSize == NO_URL) {
            ...
            if (!urlSingle.startsWith(MAIL_PREFIX)) {
                Logger.d(TAG,
                        "onChatMessageClick() size is 1 and start with browser");
                browserAlertDialog.show(activity.getFragmentManager(),
                        MultiAlertDialog.TAG);
            } else {
                Logger.d(TAG,
                        "onChatMessageClick() size is 1 and start with MAIL_PREFIX");
                ...
                public View getView(int position, View convertView,
                    ...
                    try {
                        ...
                        if (url.startsWith(RCSE_PREFIX)) {
                            Logger.d(TAG,
                                    "onChatMessageClick() it is start with rcse");
                            drawable = activity.getApplicationContext()
                                    .getResources()
                                    .getDrawable(R.drawable.rcs_icon);
                        } else {
                            drawable = activity.getPackageManager()
                                    .getActivityIcon(
            ...
            mutiAlertDialog.show(activity.getFragmentManager(),
                    MultiAlertDialog.TAG);
        }
    }
    ...
    public static class MultiAlertDialog extends DialogFragment implements
        ...
        private DialogInterface.OnClickListener mMultiClick =
