...
public class ShowPreviewActivity extends Activity implements ServiceConnectedOperation {
        ...
        Handler handler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                case ProcessorMsgType.PROCESSOR_EXCEPTION:
                    LogUtils.d(TAG, "serviceConnected,handlerMessage:EXCEPTION happened.");
    ...
    protected void onNewIntent(Intent intent) {
        ...
        LogUtils.d(TAG, "onNewIntent, mServiceHelper = " + mServiceHelper);
        // onNewIntent() will be called while double-clicking the vcs file quickly, but at this
        // point the mServiceHelper hasn't been initialized, so NPE will happen.
        if (mServiceHelper == null) {
            return;
        }
        mServiceHelper.unBindService();
