...
public class CdsPdpActivity extends Activity implements View.OnClickListener {
    ...
    private static final String[] APN_LIST = new String[] {"MMS", "SUPL", "HIPRI", "DUN", "IMS"};
    private static final int[] APN_TYPE_LIST = new int[] {ConnectivityManager.TYPE_MOBILE_MMS,
