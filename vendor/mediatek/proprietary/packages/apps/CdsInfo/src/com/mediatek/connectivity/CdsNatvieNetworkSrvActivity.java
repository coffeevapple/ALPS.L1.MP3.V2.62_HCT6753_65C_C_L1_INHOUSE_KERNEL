...
public class CdsNatvieNetworkSrvActivity extends Activity {
    ...
    private static final String IF_RULE_CMD = "ip rule show";
    private static final String IP_ROUTE_CMD = "ip -4 route show table all"; //
    private static final String IP_V6_ROUTE_CMD = "ip -6 route show table all"; //
    ...
    public void onCreate(Bundle icicle) {
        ...
        mIpRule       = (TextView) findViewById(R.id.ip_rule);
        mIpRoute       = (TextView) findViewById(R.id.ip_route);
        mIpV6Route       = (TextView) findViewById(R.id.ip_v6_route);
    ...
    private void updateFrameworkSrvInfo() {
        ...
        executeShellCmd(IF_RULE_CMD, R.id.ip_rule);
        mIpRoute.setText(R.string.loading_string);

        executeShellCmd(IP_ROUTE_CMD, R.id.ip_route);
        mIpRoute.setText(R.string.loading_string);

        executeShellCmd(IP_V6_ROUTE_CMD, R.id.ip_v6_route);
        mIpRoute.setText(R.string.loading_string);
    ...
    private void updateInfo(int id, String output) {
        ...
        case R.id.ip_v6_route:
            mIpV6Route.setText(output);
            break;

        case R.id.ip_rule:
            mIpRule.setText(output);
            break;
