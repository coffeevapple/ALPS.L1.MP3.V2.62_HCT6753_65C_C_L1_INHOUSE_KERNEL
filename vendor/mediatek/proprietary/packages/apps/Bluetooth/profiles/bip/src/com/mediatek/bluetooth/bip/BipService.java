...
import com.mediatek.bluetooth.IBluetoothBipi;
import com.mediatek.bluetooth.IBluetoothBipr;
...
*/
    ...
    private void sendStateChangedBroadcast( Context context, boolean isResponder , int state ){
        ...
        if ( null != intent ) {
            ...
            if( isResponder ){
                intent.putExtra(BluetoothProfileManager.EXTRA_PROFILE, BluetoothProfileManager.Profile.BIP_RESPONDER);
                ...
                intent.putExtra(BluetoothProfileManager.EXTRA_PROFILE, BluetoothProfileManager.Profile.BIP_INITIATOR);
                intent.putExtra(BluetoothDevice.EXTRA_DEVICE,
