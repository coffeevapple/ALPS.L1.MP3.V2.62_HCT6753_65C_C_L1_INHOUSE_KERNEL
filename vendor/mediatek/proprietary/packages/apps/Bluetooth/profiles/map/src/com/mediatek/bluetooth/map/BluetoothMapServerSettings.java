...
public class BluetoothMapServerSettings
    ...
    public void onCreate(PreferenceActivity parentActivity) {
		...
		Intent intent = new Intent(IBluetoothMapSetting.class.getName());
		intent.setComponent(new ComponentName("com.mediatek.bluetooth", "com.mediatek.bluetooth.map.BluetoothMapServerService"));
        if (!parentActivity.bindService(intent, mConnection, Context.BIND_AUTO_CREATE)) {
