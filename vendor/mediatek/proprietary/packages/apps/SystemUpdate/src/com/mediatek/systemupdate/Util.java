...
/**
 * This is util class for system update.
 */
public final class Util {
    ...
    public static class Action {
        ...
        public static final String ACTION_AUTO_QUERY_NEWVERSION =
                "com.mediatek.systemupdate.AUTO_QUERY_NEWVERSION";
        public static final String ACTION_AUTO_DOWNLOAD =
                "com.mediatek.systemupdate.ACTION_AUTO_DOWNLOAD";
        public static final String ACTION_UPDATE_REMIND =
                "com.mediatek.systemupdate.UPDATE_REMIND";
        public static final String ACTION_UPDATE_REPORT =
                "com.mediatek.systemupdate.UPDATE_REPORT";
        public static final String ACTION_REPORT_ACTIVITY =
                "com.mediatek.systemupdate.UpdateReport";
        public static final String ACTION_REFRESH_TIME_OUT =
                "com.mediatek.systemupdate.REFRESH_TIME_OUT";
        public static final String ACTION_AUTO_DL_TIME_OUT =
                "com.mediatek.systemupdate.AUTO_DL_TIME_OUT";
        public static final String ACTION_UPDATE_TYPE_OPTION =
                "com.mediatek.systemupdate.UPDATE_TYPE_OPTION";
        public static final String ACTION_MEDIA_MOUNT_UPDATEUI =
                "com.mediatek.systemupdate.ACTION_MEDIA_MOUNTED";
        public static final String ACTION_MEDIA_UNMOUNT_UPDATEUI =
                "com.mediatek.systemupdate.ACTION_MEDIA_UNMOUNTED";
        ...
        public static final String ACTION_INSTALL_REMINDER =
                "com.mediatek.systemupdate.InstallReminder";
        public static final String ACTION_SYSTEM_UPDATE_ENTRY =
    ...
    static boolean isSdcardAvailable(Context context) {
        ...
        if (is2SdcardSwap() || isSharedSdcard()) {
    ...
    static String getDeviceVersionInfo(Context context) {
        ...
        //modify the way to get product due to system property value changed.
        String productString  = SystemProperties.get("ro.product.name");
        String product = TextUtils.substring(productString, 5, productString.length());
        ...
        if (buildnumber.contains("keys") || !(buildnumber.startsWith("ALPS"))) {
            Xlog.i(TAG, "Get build number from 'ro.mediatek.version.release'");
    ...
    static void cancelAlarm(Context context, String action) {
        Xlog.i(TAG, "cancelAlarm, action = " + action + ", current time = "
                + Calendar.getInstance().getTimeInMillis());
        Intent it = new Intent(action);
        AlarmManager alarmMgr = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        PendingIntent operation = PendingIntent.getBroadcast(context, 0, it,
    ...
    /**
     * return the package path need to download to.
    ...
    /**
     * @param context the current context.
     * @return upgrade package file name.
     */
    ...
    /**
     *
     * @return true if support emmc.
     */
    public static boolean isEmmcSupport() {
        boolean ret = false;

        ret = SystemProperties.get("ro.mtk_emmc_support").equals("1");

        Xlog.i(TAG, "isEmmcSupport: " + ret);
    ...
    public static boolean isGeminiSupport() {
        ...
        Xlog.i(TAG, "isGeminiSupport: " + ret);
    ...
    /**
     *
     * @return true if shared sdcard is open.
     */
    public static boolean isSharedSdcard() {
        boolean ret = false;

        ret = SystemProperties.get("ro.mtk_shared_sdcard").equals("1");

        Xlog.i(TAG, "isSharedSdcard: " + ret);
    ...
    /**
     *
     * @return true if 2sdcard swap is open.
     */
    public static boolean is2SdcardSwap() {
        ...
        Xlog.i(TAG, "is2SdcardSwap: " + ret);

        return ret;
    }

    private static boolean isGmsLoad2() {
        String ret;
        ret = SystemProperties.get("ro.com.google.gmsversion");
        Xlog.i(TAG, " gms version == " + ret);

        // If it is GMS load,the value of ret will like 4.4_rx, otherwise the
        // value will be empty
