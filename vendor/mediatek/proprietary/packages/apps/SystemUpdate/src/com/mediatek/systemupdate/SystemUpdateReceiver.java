...
public class SystemUpdateReceiver extends BroadcastReceiver {
    ...
    private void showDlReminderNotification(Context context, boolean isForDL) {
        ...
        if (isForDL) {
            ...
            if (Util.isSdcardAvailable(context)) {
                ...
                notification.showDownloadingNotificaton(downloadInfo.getVerNum(),
    ...
    private void startReportActivity() {
        ...
        resultNotify.putExtra(ForegroundDialogService.DLG_ID,
                ForegroundDialogService.DIALOG_UPDATE_RESULT);
