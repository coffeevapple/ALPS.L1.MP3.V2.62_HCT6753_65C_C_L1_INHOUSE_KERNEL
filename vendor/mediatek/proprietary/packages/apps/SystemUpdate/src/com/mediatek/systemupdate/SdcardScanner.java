...
/**
 *
 * To scan SD upgrade package in sd card.
 *
 */
public class SdcardScanner {
    ...
    private static final Comparator<UpdatePackageInfo> COMPARATOR =
            new Comparator<UpdatePackageInfo>() {
    ...
    /**
     *
     * @return update package info list.
     */
    public List<UpdatePackageInfo> querySdcardPackage() {
        ...
        boolean isNotFoundOta =
                downloadInfo.getDLSessionStatus() != DownloadInfo.STATE_NEWVERSION_READY;
    ...
    private boolean checkVersion(PackageInfoReader sdPkgInfoReader) {
        ...
        if (!((TextUtils.isEmpty(OPER_DEV) && TextUtils.isEmpty(operPkg)) || OPER_DEV
         ...
         //do not check flavor since flavor is not correct:full_xxx-eng
