...
public class SetAlarm extends PreferenceActivity
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mTimePref) {
        	 Xlog.d(TAG, "showDialog(DIALOG_TIMEPICKER)");
    ...
    public Dialog onCreateDialog(int id) {
        ...
        case DIALOG_TIMEPICKER:
        	 Xlog.d(TAG, "onCreateDialog(DIALOG_TIMEPICKER)");
    ...
    @Override
     public void onConfigurationChanged(Configuration newConfig) {
       ...
       Xlog.d(TAG, "onConfigurationChanged: " + newConfig.orientation + ",remove timer picker dialog");
