...
public class JNITestAdapter implements IVoiceAdapter {
     ...
     *
     * @param dispatcher NativaDataManager instance
     * @param cfgmgr ConfigurationManager instance
     */
...
//        message.mPkgName = processinfo.mProcessName;
    ...
    public int startVoiceContacts(String processname, int pid,
        ...
        Log.i(TAG, "startVoiceContacts screenOrientation "
                + screenOrientation);
...
//        curHandler.sendMessageDelayed(m, mDelaytime);
    ...
    public int sendContactsName(String modelpath, String contactspath, String[] allContactsName) {
        Log.i(TAG,
                "sendVoiceContacts : " + Arrays.toString(allContactsName));
