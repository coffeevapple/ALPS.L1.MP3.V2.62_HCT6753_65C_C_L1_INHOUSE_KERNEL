...
public class VoiceCommandTest extends InstrumentationTestCase {
    ...
    private void handleVoiceCommandNotified(int mainAction, int subAction, Bundle extraData) {
        ...
        case VoiceCommandListener.ACTION_MAIN_VOICE_TRAINING:
            ...
            } else if (subAction == VoiceCommandListener.ACTION_VOICE_TRAINING_PASSWORD_FILE) {
        ...
        case VoiceCommandListener.ACTION_MAIN_VOICE_RECOGNITION:
             assertEquals(VoiceCommandListener.ACTION_EXTRA_RESULT_SUCCESS, result);
            if (subAction == VoiceCommandListener.ACTION_VOICE_RECOGNITION_NOTIFY) {
                ...
                Log.i(TAG, "recognizeResult = " + recognizeResult + "recognizeConfidence = "
                        + recognizeConfidence);
            } else if (subAction == VoiceCommandListener.ACTION_VOICE_RECOGNITION_INTENSITY) {
                int intensity = extraData.getInt(VoiceCommandListener.ACTION_EXTRA_RESULT_INFO);
                Log.i(TAG, "intensity = " + intensity);
            }
            break;
     ...
     public void test01_SendVoiceUI() {
        ...
        bundle.putInt(VoiceCommandListener.ACTION_EXTRA_SEND_INFO1,
                VoiceCommandListener.VOICE_WAKEUP_MODE_UNLOCK);
        int[] commandMask = { 3, 1 };
    ...
    public void test02_SendVoiceTraining() {
        ...
        TestSleep.sleep(1000);
        sendVoiceCommand(mPkgName, VoiceCommandListener.ACTION_MAIN_VOICE_TRAINING,
                VoiceCommandListener.ACTION_VOICE_TRAINING_PASSWORD_FILE, bundle);
        TestSleep.sleep(1000);
        sendVoiceCommand(mPkgName, VoiceCommandListener.ACTION_MAIN_VOICE_TRAINING,
        ...
        TestSleep.sleep(1000);
        sendVoiceCommand(mPkgName, VoiceCommandListener.ACTION_MAIN_VOICE_TRAINING,
                VoiceCommandListener.ACTION_VOICE_TRAINING_PASSWORD_FILE, null);
        TestSleep.sleep(1000);
        sendVoiceCommand(mPkgName, VoiceCommandListener.ACTION_MAIN_VOICE_TRAINING,
    ...
    public void test03_SendVoiceRecognize() {
        if (!VoiceRecognizeBusiness.MTK_VOICE_UNLOCK_SUPPORT) {
        ...
        sendVoiceCommand(mPkgName, VoiceCommandListener.ACTION_MAIN_VOICE_RECOGNITION,
