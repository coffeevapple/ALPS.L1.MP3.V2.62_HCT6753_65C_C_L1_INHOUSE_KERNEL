        ...
        public void handleMessage(Message msg) {
            ...
            case EVENT_NW_INFO:
                ...
                if (ar.exception == null) {
                    ...
                    Xlog.v(TAG, "flag is : " + data[0].substring(FLAG_OFFSET));
        ...
        if (result != null && result.length > 0) {
            ...
            if (queryWhat == EVENT_HSPA_INFO) {
                ...
                if (mode != null && mode.length > 1) {
                    try {
                        Xlog.v(TAG, "mode[1]: \"" + mode[1] + "\"");
                        updateDcUI(Integer.parseInt(mode[1].trim()));
                    } catch (NumberFormatException e) {
                        Xlog.e(TAG, "Modem return invalid mode: " + mode[1]);
