...
public class ModemSwitch extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (mRadioWg.isChecked()) {
            Xlog.d(TAG, "Set modem type: " + ModemSwitchHandler.MD_TYPE_WG);
            if (sProjectType == PROJ_TYPE_WORLD_PHONE) {
            ...
            Xlog.d(TAG, "Set modem type: " + ModemSwitchHandler.MD_TYPE_TG);
            if (sProjectType == PROJ_TYPE_WORLD_PHONE) {
            ...
            Xlog.d(TAG, "Set modem type: " + ModemSwitchHandler.MD_TYPE_LWG);
            if (sProjectType == PROJ_TYPE_WORLD_PHONE) {
            ...
            Xlog.d(TAG, "Set modem type: " + ModemSwitchHandler.MD_TYPE_LTG);
            if (sProjectType == PROJ_TYPE_WORLD_PHONE) {
