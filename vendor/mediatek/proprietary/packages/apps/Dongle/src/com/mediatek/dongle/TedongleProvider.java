...
public class TedongleProvider extends ContentProvider
{
    private static final String DATABASE_NAME = "tedongle.db";
    ...
    private static final String TAG = "3GD-TedongleProvider";
    ...
    static {
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers", URL_TELEPHONY);
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/current", URL_CURRENT);
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/#", URL_ID);
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/restore", URL_RESTOREAPN);
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/preferapn", URL_PREFERAPN);
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/preferapn_no_update", URL_PREFERAPN_NO_UPDATE);

        s_urlMatcher.addURI("com.mediatek.dongle", "siminfo", URL_SIMINFO);

        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/subId/*", URL_TELEPHONY_USING_SUBID);
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/current/subId/*", URL_CURRENT_USING_SUBID);
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/restore/subId/*", URL_RESTOREAPN_USING_SUBID);
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/preferapn/subId/*", URL_PREFERAPN_USING_SUBID);
        s_urlMatcher.addURI("com.mediatek.dongle", "carriers/preferapn_no_update/subId/*",
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        switch (match) {
            case URL_TELEPHONY_USING_SUBID: {
                ...
                */
                qb.appendWhere("numeric = '" + mTelephonyManager.getSimOperator()+"'");
    ...
    public String getType(Uri url)
    {
        ...
        case URL_TELEPHONY:
        case URL_TELEPHONY_USING_SUBID:
            return "vnd.android.cursor.dir/tedongle-carrier";

        case URL_ID:
            return "vnd.android.cursor.item/tedongle-carrier";
