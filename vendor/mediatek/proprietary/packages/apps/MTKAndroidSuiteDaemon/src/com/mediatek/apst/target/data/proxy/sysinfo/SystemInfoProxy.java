...
//        return Environment.getExternalStorageDirectory().getPath();
    ...
    public static int getSimState(int simId) {
        ...
        if (Config.MTK_GEMINI_SUPPORT) {
            if (Message.SIM1_ID == simId) {
                simState = sTelephonyManager.getSimState(com.android.internal.telephony.PhoneConstants.SIM_ID_1);
            } else if (Message.SIM2_ID == simId) {
                simState = sTelephonyManager.getSimState(com.android.internal.telephony.PhoneConstants.SIM_ID_2);
            } else if (Config.MTK_3SIM_SUPPORT && Message.SIM3_ID == simId) {
            	simState = sTelephonyManager.getSimState(com.android.internal.telephony.PhoneConstants.SIM_ID_3);
            } else if (Config.MTK_4SIM_SUPPORT && Message.SIM4_ID == simId) {
            	simState = sTelephonyManager.getSimState(com.android.internal.telephony.PhoneConstants.SIM_ID_4);
            }
        } else {
    ...
    public static boolean isSim1Accessible() {
        boolean b = false;
        if (Config.MTK_GEMINI_SUPPORT) {
            int simState = sTelephonyManager.getSimState(com.android.internal.telephony.PhoneConstants.SIM_ID_1);
    ...
    public static boolean isSim2Accessible() {
        boolean b = false;
        if (Config.MTK_GEMINI_SUPPORT) {
            int simState = sTelephonyManager.getSimState(com.android.internal.telephony.PhoneConstants.SIM_ID_2);
    ...
    public static boolean isSim3Accessible() {
        ...
        if (Config.MTK_3SIM_SUPPORT) {
            int simState = sTelephonyManager.getSimState(com.android.internal.telephony.PhoneConstants.SIM_ID_3);
    ...
    public static boolean isSim4Accessible() {
        ...
        if (Config.MTK_4SIM_SUPPORT) {
        	int simState = sTelephonyManager.getSimState(com.android.internal.telephony.PhoneConstants.SIM_ID_4);
