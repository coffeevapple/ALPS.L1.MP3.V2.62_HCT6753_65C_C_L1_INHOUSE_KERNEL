...
public class Comparer {
    ...
    private static final class CompareInfo {
        ...
        CompareInfo(int messageId, SmsCbLocation location, int gs, int serialNum, boolean readflag, long deliveryTime, String messageBody) {
        ...
        private boolean isIdentify(CompareInfo other) {
            ...
            if (mMessageId != other.mMessageId || mSerialNumber != other.mSerialNumber || !(mMessageBody.equalsIgnoreCase(other.mMessageBody))) {
                return res;
            }
    ...
    public boolean add(CellBroadcastMessage cbm) {
        ...
        CompareInfo newInfo = new CompareInfo(cbm.getServiceCategory(), smsCb.getLocation(),
                smsCb.getGeographicalScope(), smsCb.getSerialNumber(), cbm.isRead(), cbm.getDeliveryTime(), cbm.getMessageBody());
    ...
    public boolean isReadForDuplicateMessage(CellBroadcastMessage cbm) {
        ...
        CompareInfo newInfo = new CompareInfo(cbm.getServiceCategory(), smsCb.getLocation(), smsCb.getGeographicalScope(),
                smsCb.getSerialNumber(), cbm.isRead(), cbm.getDeliveryTime(), cbm.getMessageBody());
    ...
    public boolean isIdentifyMsgOver12H(CellBroadcastMessage cbm) {
        ...
        CompareInfo newInfo = new CompareInfo(cbm.getServiceCategory(),
                smsCb.getLocation(), smsCb.getGeographicalScope(), smsCb.getSerialNumber(), cbm.isRead(), cbm.getDeliveryTime(), cbm.getMessageBody());
