...
public class BackupEngine {
    ...
    private boolean setupComposer(final ArrayList<Integer> list) {
        ...
        MyLogger.logD(CLASS_TAG, "makedir end... mybe ANR happened!");
        if (result) {
            MyLogger.logD(CLASS_TAG, "create folder " + mBackupFolder
                    + " success");
    ...
    private class BackupThread extends Thread {
        ...
        public void run() {
            ...
            for (Composer composer : mComposerList) {
                MyLogger.logD(CLASS_TAG, "BackupThread->composer:" + composer.getModuleType()
                                + " start...");
            ...
            MyLogger.logD(CLASS_TAG, "BackupThread run finish, result:"
                    + result);
