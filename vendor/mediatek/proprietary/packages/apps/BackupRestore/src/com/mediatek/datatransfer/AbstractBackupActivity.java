...
//            }
        ...
        mButtonBackup.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                if (isAllChecked(false)) {
                    MyLogger.logE(CLASS_TAG, "to Backup List is null or empty");
                    return;
                }

                String path = SDCardUtils
                        .getStoragePath(AbstractBackupActivity.this);
                if (path != null) {
    ...
    protected boolean hasSelectedItem() {
        ...
        if (selectCount > 0) {
            MyLogger.logI(CLASS_TAG, "hasSelectedItem selectCount : " + selectCount);
            return true;
        } else {
            MyLogger.logI(CLASS_TAG, "hasSelectedItem No item selected");
