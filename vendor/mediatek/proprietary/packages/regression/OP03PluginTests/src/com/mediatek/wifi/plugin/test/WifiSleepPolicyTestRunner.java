...
public class WifiSleepPolicyTestRunner extends InstrumentationTestRunner {
    public static final String TAG = "WifiSleepPolicyTestRunner";

    @Override
    public TestSuite getAllTests() {
        Xlog.d(TAG, "getAllTests");
        TestSuite suite = new TestSuite();
        suite.addTestSuite(WifiSleepPolicyTest.class);
