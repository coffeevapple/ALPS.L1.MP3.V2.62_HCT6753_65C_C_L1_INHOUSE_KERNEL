...
public class MemoryTest extends SingleLaunchActivityTestCase<Memory> {
    private static final String TAG = "EM/rg/Memory";
    private static final String EMMC_PROC_FILE = "/proc/emmc";
    private static final String EMMC_NAME = "EMMC";
    private static final String NAND_NAME = "Nand Flash";
    ...
    public void test_ListInfo() {
        Xlog.d(TAG, "sHasEmmc: " + sHasEmmc);
        if (sHasEmmc) {
            assertEquals(true, sSolo.searchText(EMMC_NAME));
        } else {
            assertEquals(true, sSolo.searchText(NAND_NAME));
        }
