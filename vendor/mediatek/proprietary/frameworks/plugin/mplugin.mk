...
$(MPINFO_OUT): $(full_classes_jar) $(full_java_lib_deps) | $(ACP)
	@mkdir -p $(dir $@)
	@java -jar vendor/mediatek/proprietary/frameworks/plugin/mplugin-tool.jar $(PRIVATE_PATH) $(PRIVATE_LOCAL_MODULE) $(PRIVATE_PATH)/AndroidManifest.xml $(filter-out $< $(word 1,$^),$^) $(word 1,$^) $(PRIVATE_LOCAL_INSTALLED_MODULE)
