...
public class Light extends Actor {
    ...
    /**
     * Create the light presentation.
     * @param engine the presentation engine
     * @return the light presentation
     *
     * @hide
     */
    ...
    /**
     * Set diffuse color of this light.
     * @param color the diffuse color of light
     *
    ...
    /**
     * Set specular color of this light.
     * @param color the specular color of light
     *
     * @deprecated Use setColor() instead
     */
    @Deprecated
    ...
    /**
     * Set ambient color of this light.
     * @param color the ambient color of light
     *
