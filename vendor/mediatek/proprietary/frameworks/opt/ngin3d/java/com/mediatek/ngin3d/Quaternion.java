...
public class Quaternion {
    ...
    public final Quaternion set(Vec3 axis, float angle) {
        ...
        return this.set((float) Math.cos(halfAngle), (float) (coeff * axis.x),
            (float) (coeff * axis.y), (float) (coeff * axis.z));
    }
     ...
     *
     * @param r the quaternion that we want to apply to
     * @return the result quaternion of this operation
     ...
     *
     * @param r the quaternion that we want to multiply to
    ...
    /**
     * Spherical linear interpolation between this quaternion and
     * the other quaternion, based on the alpha value in the range.
     * [0,1]. Taken from. Taken from Bones framework for JPCT,
    ...
    public boolean equals(final Object o) {
        ...
        return this.mQ0 == comp.mQ0 && this.mQ1 == comp.mQ1
            && this.mQ2 == comp.mQ2 && this.mQ3 == comp.mQ3;
    }
