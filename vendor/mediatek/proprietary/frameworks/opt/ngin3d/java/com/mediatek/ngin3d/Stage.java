...
public class Stage extends Container {
    ...
    public void realize(PresentationEngine presentationEngine) {
        ...
        // This stage get the UI handler when constructing, and this(realize) method
        // is invoked in GL thread, so we store the instance of this stage
        // into ThreadLocal here.
    ...
    public static class ProjectionConfig implements JSON.ToJson {
        ...
        /**
         * Setup the configuration of projection.
         *
         * @param mode   the prjection mode
         * @param zNear  the Z value of near plane
         * @param zFar   the Z value of far plane
         * @param zStage the Z value of Stage
        ...
        public boolean equals(Object o) {
            ...
            if (Float.compare(that.zFar, zFar) != 0) {
                return false;
            }
            if (Float.compare(that.zNear, zNear) != 0) {
                return false;
            }
            if (Float.compare(that.zStage, zStage) != 0) {
                return false;
            }
        ...
        /**
         * Generate a text description of this object with JSON format.
         *
         * @return Descriptive text string with JSON format
         */
    ...
    public static class Camera implements JSON.ToJson {
         ...
         * @param lookAt   the lookat point of camera
         * @hide Access via configuration methods
         */
    ...
    public static class Stereo3D implements JSON.ToJson {
        ...
        /**
         * Configure the stereo3d settings.
         *
         * @param enable        true to enable the stereo3d effect and false to diable it.
         * @param focalDistance the distance between the camera and the object
         *                      in the world space you would like to focus on.
         * @param intensity     the intensity level of stereo3d effect.
         * @hide Access via configuration methods
         */
        ...
        @Override
        public String toString() {
            return "enable : " + enable + ", focalDistance : "
                + focalDistance + ", intensity : " + intensity;
        }
         ...
         * with JSON format.
         *
         * @return the description of this object with JSON format
         */
        public String toJson() {
            return "{enable : " + enable + ", focalDistance : "
                + focalDistance + ", intensity : " + intensity + "}";
    ...
    /**
     * Apply the value of properties of this actor.
     *
     * @param property the target property
     * @param value    the value apply to this property
    ...
    protected boolean applyValue(Property property, Object value) {
        ...
        if (property.sameInstance(PROP_DEBUG_CAMERA)) {
            ...
            // Not necessary to apply cause PresentationEngine
            // should read the background color automatically.
            return true;
            ...
            if (value != null) {
                ...
                mPresentationEngine.enableStereoscopic3D(
                    stereo3D.enable,
                    stereo3D.focalDistance,
                    stereo3D.intensity);
            }
            return true;
        }
     ...
     *
     * @return The list of debug camera names
     * @deprecated This method will be renamed in future, it is not a debug feature.
     */
    @Deprecated
    ...
    /**
     * Dump Scene Graph with JSON format string.
     *
     * @return the String of scene graph
     * @hide
     */
    public String dump() {
