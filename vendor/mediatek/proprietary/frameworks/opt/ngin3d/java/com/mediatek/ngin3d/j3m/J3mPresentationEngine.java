...
public class J3mPresentationEngine implements PresentationEngine {
     ...
     *
     * @param names the list of debug camera names
     * @param node the Scene Node name we want to start to traverse
     * @deprecated This function is deprecated and marked for removal in the near future.
     *
     */
    @Deprecated
