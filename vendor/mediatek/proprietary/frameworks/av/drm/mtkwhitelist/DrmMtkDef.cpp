...
bool DrmTrustedApp::IsDrmTrustedApp(const String8& procName) {
    bool result = false;
    std::vector<String8>::iterator it = TRUSTED_APP.begin();
...
bool DrmTrustedClient::IsDrmTrustedClient(const String8& procName) {
    bool result = false;
    std::vector<String8>::iterator it = TRUSTED_PROC.begin();
...
bool DrmTrustedVideoApp::IsDrmTrustedVideoApp(const String8& procName) {
    bool result = false;
    std::vector<String8>::iterator it = TRUSTED_VIDEO_APP.begin();
...
bool CtaTrustedClient::IsCtaTrustedGetTokenClient(const String8& procName) {
    bool result = false;
    std::vector<String8>::iterator it = TRUSTED_GETTOKEN_PROC.begin();
...
bool CtaTrustedClient::IsCtaTrustedCheckTokenClient(const String8& procName) {
    bool result = false;
    std::vector<String8>::iterator it = TRUSTED_CHECKTOKEN_PROC.begin();
