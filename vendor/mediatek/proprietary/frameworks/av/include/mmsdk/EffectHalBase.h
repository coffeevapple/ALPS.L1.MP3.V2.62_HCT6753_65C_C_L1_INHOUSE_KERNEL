 ...
 *         
 */
class EffectHalBase : public BnEffectHal
{
public:
                                EffectHalBase();
...
public: // may change state
    ...
    /**
     *  @brief do init(call initImpl) and change status to STATE_INIT if status is STATE_UNINIT.
     *  @details 
           - This function can not be overwrite anymore.
           - This function can called on STATE_UNINIT.
           - This function may change status to STATE_INIT.

     */
    virtual android::status_t   init() final;
    /**
     *  @brief do uninit(call uninitImpl) and change status to STATE_UNINIT if status is STATE_INIT.
     *  @details 
            - This function can not be overwrite anymore.
            - This function can called on STATE_INIT.
            - This function may change status to STATE_UNINIT.
     */
    virtual android::status_t   uninit() final;

    /**
     *  @brief Call allParameterConfigured to check all capture parameters were setting done.
     *  @details 
            - This function can not be overwrite anymore.
            - This function can called on STATE_INIT.
    ...
    */
     ...
     *  @details 
            - This function can not be overwrite anymore.
            - This function can called on STATE_CONFIGURED.
            - This function may change status to STATE_INIT.
    */
    virtual android::status_t   unconfigure() final;
    /**
     *  @brief Start feature processing(call startImpl).
     *  @details 
            - This function can not be overwrite anymore.
            - This function can called on STATE_CONFIGURED.
    ...
    */
    ...
    /**
     *  @brief Abort the feature processing.
     *  @details 
            - This function can not be overwrite anymore.
            - This function can called on STATE_RUNNING.
            - This function may change status to STATE_CONFIGURED.
    */
...
public: // would not change state
    ...
    //non-blocking
    virtual android::status_t   addInputFrame(const android::sp<IImageBuffer> frame, const android::sp<EffectParameter> parameter=NULL) final;
    //non-blocking
    virtual android::status_t   addOutputFrame(const android::sp<IImageBuffer> frame, const android::sp<EffectParameter> parameter=NULL) final;
...
protected:  //should be implement in sub-class
    ...
    //non-blocking
    virtual android::status_t   addInputFrameImpl(const android::sp<IImageBuffer> frame, const android::sp<EffectParameter> parameter=NULL) = 0;
    //non-blocking
    virtual android::status_t   addOutputFrameImpl(const android::sp<IImageBuffer> frame, const android::sp<EffectParameter> parameter=NULL) = 0;
};
