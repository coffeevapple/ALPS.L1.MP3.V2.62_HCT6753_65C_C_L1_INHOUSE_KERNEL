...
public:
    ...
    virtual void    onInputFrameProcessed(const IEffectHalClient* effectClient, const sp<EffectParameter> parameter, EffectResult partialResult) const = 0;
    /**
    ...
    virtual void    onAborted(const IEffectHalClient* effectClient, const EffectResult& result) const = 0;
    /**
