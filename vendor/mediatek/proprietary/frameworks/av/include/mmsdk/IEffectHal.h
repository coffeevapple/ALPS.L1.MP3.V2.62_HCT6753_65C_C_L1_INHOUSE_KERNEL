 ...
 *  </pre>
 */
class IEffectHal : public IInterface
{
public:
    DECLARE_META_INTERFACE(EffectHal);
...
class BnEffectHal : public BnInterface<IEffectHal>
{
public:
...
class IEffectHalClient : public IEffectHal
{
public:
...
public:
    ...
    //typedef Vector<sp<FrameInfo> >    FrameInfoVect_t;
...
//-----------------------------------------------------------------------------
    ...
    virtual void       onInputFrameProcessed(const IEffectHalClient* effect, const sp<EffectParameter> parameter, EffectResult partialResult) const;
    ...
    virtual void       onAborted(const IEffectHalClient* effect, const EffectResult& result) const;
