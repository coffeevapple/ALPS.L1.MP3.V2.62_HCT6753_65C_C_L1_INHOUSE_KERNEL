    ...
    private void checkOutOfDateSegments() {
        ...
        try {
            ...
            if (cursor != null) {
                ...
                Xlog.d(TAG, "checkOutOfDateSegments cursor size=" + cursorCount + ", phoneId=" +
    ...
    public synchronized byte[][] queryExistedSegments(TimerRecord record) {
        ...
        try {
            ...
            if (cursor != null) {
                ...
                Xlog.d(TAG, "columnSeqence =" + columnSeqence + "; columnPdu = " + columnPdu +
                ...
                for (int i = 0; i < cursorCount; ++i) {
                    ...
                    if (!cursor.isNull(columnPort)) {
                        ...
                        if (destPort != -1) {
                            Xlog.d(TAG, "segment contain port " + destPort);
