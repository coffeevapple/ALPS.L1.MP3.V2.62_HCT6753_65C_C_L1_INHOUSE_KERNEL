    ...
    private class OtherAccountSelectionReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (SELECT_OTHER_ACCOUNTS_ACTION.equals(action) && mContext instanceof Activity) {
                ...
                DefaultAccountPickerDialog defaultAccountPickerDialog = DefaultAccountPickerDialog
                        .build(mContext)
                        .setData(accountItems);

                FragmentTransaction ft = ((Activity)mContext).getFragmentManager().beginTransaction();
                ft.add(defaultAccountPickerDialog, "select_other_account");
