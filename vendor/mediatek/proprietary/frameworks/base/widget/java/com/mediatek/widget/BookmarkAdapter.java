...
public class BookmarkAdapter extends BaseAdapter {
    ...
    private final LongSparseArray<WeakReference<Bitmap>> mBitmapCache =
            new LongSparseArray<WeakReference<Bitmap>>();

    /**
     * BookmarkAdapter constructor.
     *
     * @param context The context
     * @param bookmarkItems List of BookmarkItem
     */
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            holder.mContainer = (FrameLayout) convertView.findViewById(R.id.containerView);
            holder.mContent = (ImageView) convertView.findViewById(R.id.contentView);
            holder.mDelIcon = (ImageView) convertView.findViewById(R.id.deleteView);
            convertView.setTag(holder);
        }

        loadImage(holder.mContent, position);
        if (mDeleteMode) {
            // This may lead bitmap exceed the control, seems like image cut,
            // user need to fix the size issue.
            holder.mContainer.setLayoutParams(new Gallery.LayoutParams(mDispWidth
     ...
     *
     * @param delMode The flag to enable delete mode
     */
     ...
     *
     * @return The flag to enable delete mode
     */
     ...
     *
     * @param deleteIcon Drawable resource of delete icon
     */
     ...
     * @return
     */
    private Bitmap getCachedBitmap(final LongSparseArray<WeakReference<Bitmap>> bmpCache
            , final long key) {
        synchronized (mLock) {
