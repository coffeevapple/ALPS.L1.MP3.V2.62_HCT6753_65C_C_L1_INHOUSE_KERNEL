...
public class BookmarkView extends FrameLayout {
    ...
    public BookmarkView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mImageDispWidth = a.getDimensionPixelSize(
                com.mediatek.internal.R.styleable.BookmarkView_imageDispWidth,
                resources.getDimensionPixelSize(
                    com.mediatek.internal.R.dimen.bookmark_bitmap_width));
        mImageDispHeight = a.getDimensionPixelSize(
                com.mediatek.internal.R.styleable.BookmarkView_imageDispHeight,
                resources.getDimensionPixelSize(
                    com.mediatek.internal.R.dimen.bookmark_bitmap_height));

        mSpaceBetweenIndicators = a.getDimensionPixelSize(
                com.mediatek.internal.R.styleable.BookmarkView_dotGap,
                resources.getDimensionPixelSize(com.mediatek.internal.R.dimen.bookmark_dot_gap));
        mSpaceBetweenItems = a.getDimensionPixelSize(
                com.mediatek.internal.R.styleable.BookmarkView_spaceBetweenItems,
                resources.getDimensionPixelSize(
                    com.mediatek.internal.R.dimen.bookmark_spacing));

        mMaxZoom = a.getFloat(com.mediatek.internal.R.styleable.BookmarkView_maxZoomOut
                , DEFAULT_MAX_ZOOM);
        mImageReflection = a.getFloat(
                com.mediatek.internal.R.styleable.BookmarkView_imageReflection
                , DEFAULT_REFLECTION);
     ...
     *
     * @param adapter The adapter of this view
     */
     ...
     *
     * @param reflection The reflection ratio
     */
     ...
     *
     * @param distance The distance of overscroll and overfling
     */
     ...
     *
     * @return The indicators of layout
     */
    ...
    private void refreshIndicators() {
        ...
        if (indicatorCnt > mItemCount) {
            ...
            for (int i = indicatorCnt; i < mItemCount; i++) {
                ...
                if (null != indicator) {
                    ...
                    indicator = (ImageView) mInflater.inflate(
                            R.layout.bookmarkview_indicator_layout, null, false);
                }
        ...
        if (mIndicators.getChildCount() > mCurrentSelectedPosition) {
            ((ImageView) mIndicators.getChildAt(mCurrentSelectedPosition)).getDrawable()
                    .setLevel(1);
        }
    }
    ...
    final class BookmarkDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            mItemCount = mBookmarkAdapter.getCount();
            if (DBG) {
                Xlog.d(TAG, "Bookmark data changes: mItemCount = " + mItemCount
                        + ",mOldItemCount = " + mOldItemCount + ",mCurrentSelectedPosition = "
