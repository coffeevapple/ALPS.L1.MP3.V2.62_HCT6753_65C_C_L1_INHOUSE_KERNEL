...
static jboolean enableColor(JNIEnv *env, jobject thiz, int isEnable)
{
    ...
    XLOGD("[JNI_PQ] enableColor(), enable[%d]", isEnable);
    ...
    XLOGE("[JNI_PQ] enableColor(), not supported!");
    return JNI_FALSE;
...
static jboolean enableSharpness(JNIEnv *env, jobject thiz, int isEnable)
{
    ...
    XLOGD("[JNI_PQ] property set... enableSharpness[%d]", isEnable);

    return JNI_TRUE;
#else
    UNUSED(isEnable);

    XLOGE("[JNI_PQ] enableSharpness(), not supported!");
    return JNI_FALSE;
...
static jboolean enableDynamicContrast(JNIEnv *env, jobject thiz, int isEnable)
{
    ...
    XLOGD("[JNI_PQ] property set... enableDynamicContrast[%d]", isEnable);

    return JNI_TRUE;
#else
    UNUSED(isEnable);

    XLOGE("[JNI_PQ] enableDynamicContrast(), not supported!");
    return JNI_FALSE;
...
static jboolean enableGamma(JNIEnv *env, jobject thiz, int isEnable)
{
    ...
    XLOGE("[JNI_PQ] enableGamma(), not supported!");
    return JNI_FALSE;
