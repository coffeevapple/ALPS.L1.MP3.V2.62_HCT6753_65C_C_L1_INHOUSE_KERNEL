...
public class AGifEncoder {
    ...
    // @hide
    /**
      * Return the boolean result of set gif duration.
      *
      * @param duration  the gif play time.
      * @return Returns the boolean result of set gif duration.
      * @hide
      * @internal
      */
    ...
    // @hide
    /**
      * Return the AGifEncoder object.
      *
      * @param width, height  the gif width and height.
      * @return Returns AGifEncoder object.
      * @hide
      * @internal
      */
    public static AGifEncoder create( int width, int height ){
        if (width == 0 || height ==0) {
            throw new NullPointerException();
        }
        //fStream = stream ;
    ...
    // @hide
    /**
      * Return the boolean result of encode bitmap to a gif.
      *
      * @param bitmap, stream  the source bitmap which encode to the OutputStream stream.
      * @return Returns the boolean result of encode bitmap to a gif.
      * @hide
      * @internal
      */
...
//     */
    /**
      * Return the boolean result of release all the Info stored for GIF.
      * After this method is call, AGifEncoder Object should no longer be used.
      *
      * @param stream  the OutputStream which would be closed.
      * @return Returns the boolean result of release all the Info stored for GIF.
      * @hide
      * @internal
      */	
