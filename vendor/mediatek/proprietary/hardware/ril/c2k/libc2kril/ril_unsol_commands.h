...
*/
    ...
    {NULL, NULL, DONT_WAKE},	//1043,	1043~1049 just reserved for android update from kk(android 4.4) to next version
    {NULL, NULL, DONT_WAKE}, 	
    {NULL, NULL, DONT_WAKE}, 	//1045
    {NULL, NULL, DONT_WAKE}, 
    {NULL, NULL, DONT_WAKE}, 
    {NULL, NULL, DONT_WAKE}, 
...
/********************* VIA add begin ******************/
    ...
    {NULL, NULL, DONT_WAKE}, //reserved for MTK+VIA JB platform , if need to add new unsol, please replace this NULL line
    {NULL, NULL, DONT_WAKE},	//1100
#endif
