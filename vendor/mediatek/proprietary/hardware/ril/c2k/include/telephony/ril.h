...
// Disable DATA_CHANNEL if pppd support is true
typedef enum {
    AT_CHANNEL,
    DATA_CHANNEL,
    MISC_CHANNEL,
...
typedef enum {
    ...
    RADIO_STATE_OFF_CARD_SWITCH = 15 /*For card switch, radio off and close uim card*/
} RIL_RadioState;
...
typedef void (*RIL_ReportUsbDisconn)();

typedef void (*RIL_ReportSocketConn)(int conn);
