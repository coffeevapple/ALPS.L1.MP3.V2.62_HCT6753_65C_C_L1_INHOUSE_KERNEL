    ...
    if  ( pImgBuf != 0 )
    {
        ...
        if (NULL != getGestureDevice())
        {
            ...
            if (pImageBuffer != 0)
            {
                ...
                if(!numOfDetected) {
                    MY_LOGD_IF(1, "numOfDetected = 0, set dummy result");
                    pDetectedResult[0].pose = HAND_POSE_VICTORY;
                    pDetectedResult[0].confidence = 0;
                    pDetectedResult[0].rect.p.x = 0;
                    pDetectedResult[0].rect.p.y = 0;
                    pDetectedResult[0].rect.s.w = 0;
                    pDetectedResult[0].rect.s.h = 0;
                    pDetectedResult[0].id = -1;
                }
