...
status_t AudioALSAFMController::setFmEnable(const bool enable, const audio_devices_t output_device, bool bForceControl, bool bForce2DirectConn) // TODO(Harvey)
{
    ...
    if (enable == mFmEnable)
    {
        //if (mFmEnable == true && mIsFmDirectConnectionMode == true) //Depend on mUseAudioPatchForFm
        {
