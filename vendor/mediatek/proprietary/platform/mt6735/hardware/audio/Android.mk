...
LOCAL_SRC_FILES+= \
    $(LOCAL_COMMON_PATH)/hardware/audio/aud_drv/audio_hw_hal.cpp \
    $(LOCAL_COMMON_PATH)/hardware/audio/aud_drv/AudioMTKFilter.cpp \
    $(LOCAL_COMMON_PATH)/hardware/audio/aud_drv/AudioMTKDec.cpp \
    ...
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSAPlaybackHandlerOffload.cpp \
    ...
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSAPlaybackHandlerI2SHDMI.cpp \
    ...
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSACaptureDataProviderVoiceUL.cpp \
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSACaptureDataProviderVoiceDL.cpp \
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSACaptureDataProviderVoiceMix.cpp \
    ...
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSADeviceConfigManager.cpp \
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioALSACodecDeviceOutReceiverSpeakerSwitch.cpp \
    ...
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/AudioVolumeFactory.cpp \
    $(LOCAL_COMMON_PATH)/hardware/audio/V3/aud_drv/SpeechDataProcessingHandler.cpp \
