...
MBOOL PipHalImp::GetHwMaxFrameRate(MINT32 i4SensorDev, MUINT32 &ZsdHwMaxFrameRate, MUINT32 &NonZsdHwMaxFrameRate)
{
   ...
   MUINT32 aiHwMaxFrameRate[2]; // 0: Non-ZSD (PV), 1: ZSD (Full).
    ...
    #ifdef USING_D3
    PIP_DBG("D3 Zsd/NonZsd HW Max FrmRate(%d, %d), Sensor Typ/InDev/CurrDev/Idx: (%d <RAW1YUV2>, %d <Main1Sub2>, %d, %d), PV W/H: (%d, %d), Full W/H: (%d, %d)", ZsdHwMaxFrameRate, NonZsdHwMaxFrameRate, i4SensorType, i4SensorDev, i4CurrSensorDev, mSensorIdx, i4SensorPreviewWidth, i4SensorPreviewHeight, i4SensorFullWidth, i4SensorFullHeight);
    #endif // USING_D3
