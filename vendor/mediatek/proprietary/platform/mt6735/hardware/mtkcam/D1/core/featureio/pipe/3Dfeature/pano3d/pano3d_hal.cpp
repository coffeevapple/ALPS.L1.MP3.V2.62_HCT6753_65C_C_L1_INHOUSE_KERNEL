...
)
{
    ...
    CAM_LOGD("[mHal3dfInit] MavInitInData 0x%p MotionInitInData 0x%p WarpInitInData 0x%p Pano3DInitInData 0x%p\n",MavInitInData,MotionInitInData,WarpInitInData,Pano3DInitInData);
    if (m_pMTKMavObj) 
    ...
    MyPano3DIamgeInfo.WorkingBuffAddr = (MUINT8 *)Pano3DInitInData;
