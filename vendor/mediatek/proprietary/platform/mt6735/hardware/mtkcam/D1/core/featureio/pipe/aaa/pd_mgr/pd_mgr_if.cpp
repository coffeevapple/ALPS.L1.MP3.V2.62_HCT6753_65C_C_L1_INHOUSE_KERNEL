...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT IPDMgr::setPDCaliData(MINT32 i4SensorDev, MVOID *ipCaliData)
{
    if (i4SensorDev & ESensorDev_Main)
        return PDMgr::getInstance(ESensorDev_Main).setPDCaliData(ipCaliData);
    if (i4SensorDev & ESensorDev_Sub)
        return PDMgr::getInstance(ESensorDev_Sub).setPDCaliData(ipCaliData);
    if (i4SensorDev & ESensorDev_MainSecond)
        return PDMgr::getInstance(ESensorDev_MainSecond).setPDCaliData(ipCaliData);    
