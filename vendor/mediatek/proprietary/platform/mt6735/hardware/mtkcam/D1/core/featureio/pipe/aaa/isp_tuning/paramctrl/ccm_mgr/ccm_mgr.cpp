...
calculateCCM(AWB_INFO_T const& rAWBInfo, MBOOL bWithPreferenceGain, MINT32 i4FlashOnOff, MINT32 i4SmoothMethod)
{
    ...
    SmoothCCM(rAWBInfo.rAlgGain, 3, 9, m_rISPMultiCCM, m_rCCMOutput, m_rCCMWeight, i4FlashOnOff, i4SmoothMethod);
    else
        SmoothCCM(rAWBInfo.rCurrentFullAWBGain, 3, 9, m_rISPMultiCCM, m_rCCMOutput, m_rCCMWeight, i4FlashOnOff, i4SmoothMethod);
}
