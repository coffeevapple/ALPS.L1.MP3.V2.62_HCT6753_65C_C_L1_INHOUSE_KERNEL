...
setParameters()
{
    ...
    //Check EV mode change
    {
        ...
        if (newParam != oldParam)
        {   
            mpDefaultCtrlNode->updateDelay(EQueryType_Ev);
    ...
    //check Saturation mode change
    {
        ...
        if (newParam != oldParam)
        {   
            mpDefaultCtrlNode->updateDelay(EQueryType_Sat);      
    ...
    //check Brightness mode change
    {
        ...
        if (newParam != oldParam)
        {
            mpDefaultCtrlNode->updateDelay(EQueryType_Bright);   
    ...
    //check Contrast mode change
    {
        ...
        if (newParam != oldParam)
        {
            mpDefaultCtrlNode->updateDelay(EQueryType_Contrast);   
