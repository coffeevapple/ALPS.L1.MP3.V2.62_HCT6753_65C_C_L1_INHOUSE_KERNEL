...
//
#include <mtkcam/D1/core/camshot/inc/CamShotUtils.h>
//
// for PDAF feature
...
//
// for ZSD extension
#include <mtkcam/D1/v1/adapter/inc/Scenario/Shot/ScenarioShotUtils.h>
...
onPostBuffer(MUINT32 const data, MUINTPTR const buf, MUINT32 const ext)
{
...

    {
        ...
        if( mDropFrameCnt > 0 )
        {
            mDropFrameCnt--;
            doPost = MFALSE;
            MY_LOGD("drop frame, remain %d to drop", mDropFrameCnt);
        }
    }
