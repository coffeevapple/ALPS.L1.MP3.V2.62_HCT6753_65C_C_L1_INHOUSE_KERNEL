...
typedef struct
{
    unsigned int*                        pDescriptorArray;   //CAM_MODULE_ENUM
    unsigned int*                        pDesriptorNum;      // the descriptor number that need to be updated
    unsigned int*                        pTopCtlEn1;         // top ctl en1 flag
    unsigned int*                        pTopCtlEn2;         // top ctl en2 flag
    unsigned int*                        pTopCtlDma;         // top ctl DMA flag
