...
public:     ////                    Instantiation.
                                    ...
                                    enum EngSensorMode { // Duplicate from sensor_hal.h (mediatek\platform\mt6589\hardware\camera\inc\drv\)
                                        ENG_SENSOR_MODE_PREVIEW = 0,            // ACDK_SCENARIO_ID_CAMERA_PREVIEW=0,
                                        ENG_SENSOR_MODE_CAPTURE = 1,            // ACDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG,
                                        ENG_SENSOR_MODE_VIDEO_PREVIEW = 2,      // ACDK_SCENARIO_ID_VIDEO_PREVIEW,
