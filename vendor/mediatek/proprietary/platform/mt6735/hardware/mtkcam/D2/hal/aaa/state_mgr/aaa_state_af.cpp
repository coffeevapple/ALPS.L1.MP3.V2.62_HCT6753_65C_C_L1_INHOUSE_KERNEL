...
#include <mtkcam/D2/hal/aaa/aaa_hal_raw.h>
#include <mtkcam/D2/hal/aaa/state_mgr/aaa_state.h>
#include <mtkcam/D2/hal/aaa/state_mgr/aaa_state_mgr.h>
//#include <mtkcam/core/featureio/pipe/aaa/aaa_scheduler.h>
//#include <aaa_common_custom.h>

#include <mtkcam/D2/hal/aaa/ae_mgr/ae_mgr_if.h>
#include <mtkcam/D2/hal/aaa/flash_mgr/flash_mgr.h>
#include <flash_feature.h>
#include <mcu_drv.h>
#include <mtkcam/D2/hal/aaa/af_mgr/af_mgr.h>
#include <mtkcam/D2/hal/aaa/buf_mgr/afo_buf_mgr.h>
#include <mtkcam/D2/hal/aaa/awb_mgr/awb_mgr_if.h>
#include <mtkcam/D2/hal/aaa/buf_mgr/aao_buf_mgr.h>
#include <mtkcam/D2/hal/aaa/lsc_mgr/lsc_mgr2.h>
#include <mtkcam/D2/hal/aaa/flicker/flicker_hal_base.h>
#include <mtkcam/D2/hal/aaa/sensor_mgr/aaa_sensor_mgr.h>
...
//#if 0 /*FIXME*/
        ...
        MY_LOG_IF(m_3ALogEnable, "eAFState_PreAF-cust_isNeedAFLamp ononff:%d flashM:%d AfLampM:%d triger:%d",
...
/*
    ...
    AfMgr::getInstance().getAFRefWin(m_SensorDevId, rWinSize);
    ...
    AeMgr::getInstance().getAEMeteringYvalue(m_SensorDevId, rAeWinSize, &iYvalue);
    ...
    AeMgr::getInstance().getAEBlockYvalues(m_SensorDevId, rAEInfo.aeBlockV, 25);
    AeMgr::getInstance().getPreviewParams(m_SensorDevId, rPreviewInfo);
    AeMgr::getInstance().getRTParams(m_SensorDevId, AEFrameParam);
    rAEInfo.i4IsAEStable= AeMgr::getInstance().IsAEStable(m_SensorDevId);
