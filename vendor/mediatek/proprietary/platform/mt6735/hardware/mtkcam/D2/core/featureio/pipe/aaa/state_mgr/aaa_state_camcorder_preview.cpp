...
{
    MY_LOG_IF(sm_3APvLogEnable,"[StateCamcorderPreview::sendIntent<eIntent_AFUpdate>] enter\n");
    MRESULT err = S_3A_OK;
    BufInfo_T rBufInfo;
    ...
    MY_LOG_IF(sm_3APvLogEnable,"[StateCamcorderPreview::sendIntent<eIntent_AFUpdate>] deQHwBufAFO done\n");
    ...
    MY_LOG_IF(sm_3APvLogEnable,"[StateCamcorderPreview::sendIntent<eIntent_AFUpdate>] doAF done\n");

    // Enqueue AFO DMA buffer
    BufMgr::getInstance().enqueueHwBuf(ECamDMA_AFO, rBufInfo);
    MY_LOG_IF(sm_3APvLogEnable,"[StateCamcorderPreview::sendIntent<eIntent_AFUpdate>] enQHwBuf done\n");
