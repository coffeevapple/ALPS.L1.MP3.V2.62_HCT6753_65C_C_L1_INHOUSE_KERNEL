...
MRESULT AfMgr::setAFArea(CameraFocusArea_T a_sAFArea)
{
    ...
    {
        a_sAFArea.u4Count = 1;
        a_sAFArea.rAreas[0].i4Left     = (m_sAFInput.sEZoom.i4W/2) - (m_sAFInput.sEZoom.i4W/2)*m_NVRAM_LENS.rAFNVRAM.i4SPOT_PERCENT_W / 100;
        a_sAFArea.rAreas[0].i4Right  = (m_sAFInput.sEZoom.i4W/2) + (m_sAFInput.sEZoom.i4W/2)*m_NVRAM_LENS.rAFNVRAM.i4SPOT_PERCENT_W / 100;
        a_sAFArea.rAreas[0].i4Top     = (m_sAFInput.sEZoom.i4H/2) - (m_sAFInput.sEZoom.i4H/2)*m_NVRAM_LENS.rAFNVRAM.i4SPOT_PERCENT_H / 100;
        a_sAFArea.rAreas[0].i4Bottom = (m_sAFInput.sEZoom.i4H/2) + (m_sAFInput.sEZoom.i4H/2)*m_NVRAM_LENS.rAFNVRAM.i4SPOT_PERCENT_H / 100;
    }
...
MVOID AfMgr::setAFWinTH(AF_CONFIG_T a_sAFConfig)
{
    ...
    else
    {
        ...
        IOPIPE_SET_MODUL_REG(handle, CAM_AF_TH, 0x01000000+(Boundary(0, a_sAFConfig.AF_TH[2], 255)<<16)+ Boundary(0, a_sAFConfig.AF_TH[0], 255));
