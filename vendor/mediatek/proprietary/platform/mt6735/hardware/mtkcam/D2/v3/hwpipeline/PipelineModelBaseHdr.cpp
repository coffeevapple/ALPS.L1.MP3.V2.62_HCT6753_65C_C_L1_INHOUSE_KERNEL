...
/*MVOID
PipelineModelBaseHdr::
setCallback(wp<IPipelineHdrCallback> pCB)
{
    mpCB = pCB;
}*/
...
/*.     //
        ...
        MY_LOGE_IF(pFrame==0, "frameNo:%u - NULL PipelineFrame", request.frameNo);
        MY_LOGD_IF(
            mLogLevel >= 1,
            "frameNo:%u Image:I|O=%zu|%zu Meta:I|O=%zu|%zu",
            params.pAppRequest->frameNo,
      ...
      */
        ...
        //for ( int i=0; i<params.vFrame.size(); i++ ) {
            sp<IPipelineFrame> pFrame = params.vFrame[0];
