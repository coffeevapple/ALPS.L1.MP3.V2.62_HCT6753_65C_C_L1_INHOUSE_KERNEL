...
Hal3ABase::createInstance(MINT32 const i4SensorDevId)
{
    ...
    if (!pIHalSensorList) return NULL;

    pIHalSensorList->querySensorStaticInfo(i4SensorDevId, &sensorStaticInfo); // sensor hal defined
    MINT32 eSensorType = sensorStaticInfo.sensorType;
