...
typedef struct
{
    ...
    MUINT8* pSourceImgBufAddr[HDR_MAX_IMAGE_NUM];	// image_addr[3]; // input image address

	// For MAV Drv Init.
    MUINT8* pMavWorkingBufAddr;
...
typedef struct
{
    ...
    MUINT8* pSourceImgBufAddr[HDR_MAX_IMAGE_NUM];	// source_image_addr[3]; // source image address
    MUINT8* pSmallImgBufAddr[HDR_MAX_IMAGE_NUM];	// small_image_addr[3]; // small image address
...
typedef struct
{
    ...
    MUINT8* pSEImgBufAddr[HDR_MAX_IMAGE_NUM];	// se_image_addr;
...
typedef struct
{
    ...
    MUINT8* pSmallImgBufAddr[HDR_MAX_IMAGE_NUM];	// ImgAddr;
