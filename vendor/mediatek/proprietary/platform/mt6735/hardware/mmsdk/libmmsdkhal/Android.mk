...
ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)),mt6753 mt6735))
...
ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)),mt6753 mt6735))
#ifeq ($(strip $(TARGET_BOARD_PLATFORM)),mt6753)
LOCAL_C_INCLUDES += $(MTK_PATH_PLATFORM)/hardware/include/D1
endif
...
LOCAL_SHARED_LIBRARIES += libmmsdkservice.feature_platform
endif
